import { t as applyModelCompatPatch } from "./provider-model-compat-CHKL1orB.js";
...
function shouldApplyOpenAIToolCompat(ctx) {
	...
	if (provider === "openai") return api === "openai-responses" && (!baseUrl || isOpenAIResponsesBaseUrl(baseUrl));
	if (provider === "openai-codex") return api === "openai-codex-responses" && (!baseUrl || isOpenAIResponsesBaseUrl(baseUrl) || isOpenAICodexBaseUrl(baseUrl));
	return false;
}
...
//#endregion
export { buildProviderToolCompatFamilyHooks as a, inspectGeminiToolSchemas as c, normalizeOpenAIToolSchemas as d, resolveXaiModelCompatPatch as f, cleanSchemaForGemini as g, GEMINI_UNSUPPORTED_SCHEMA_KEYWORDS as h, applyXaiModelCompat as i, inspectOpenAIToolSchemas as l, stripXaiUnsupportedKeywords as m, XAI_TOOL_SCHEMA_PROFILE as n, findOpenAIStrictSchemaViolations as o, stripUnsupportedSchemaKeywords as p, XAI_UNSUPPORTED_SCHEMA_KEYWORDS as r, findUnsupportedSchemaKeywords as s, HTML_ENTITY_TOOL_CALL_ARGUMENTS_ENCODING as t, normalizeGeminiToolSchemas as u };
