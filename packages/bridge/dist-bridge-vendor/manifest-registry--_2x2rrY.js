...
import { a as normalizeOptionalTrimmedStringList } from "./string-normalization-DO5qgVap.js";
import { m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { i as loadPluginManifest } from "./manifest-DVVfeFh-.js";
import { g as loadBundleManifest, l as isPathInside, o as discoverOpenClawPlugins, r as normalizeChatChannelId, s as resolvePluginCacheInputs, u as safeRealpathSync } from "./ids-BhKtFNS_.js";
import { o as resolveCompatibilityHostVersion } from "./version-BajQ5RLp.js";
import { n as defaultSlotIdForKey } from "./slots-YfKufJfg.js";
...
function resolveEnableStateShared(params, resolveState) {
...
function resolvePluginActivationState(params) {
	...
	if (params.origin === "workspace" && !explicitlyAllowed && entry?.enabled !== true && explicitSelection.reason !== "selected context engine slot") return {
		enabled: false,
		activated: false,
		explicitlyEnabled: explicitSelection.explicitlyEnabled,
		source: "disabled",
...
function hasExplicitPluginConfig(plugins) {
	return hasExplicitPluginConfig$1(plugins);
}
function isBundledChannelEnabledByChannelConfig(cfg, pluginId) {
	return isBundledChannelEnabledByChannelConfig$1(cfg, pluginId);
}
...
//#endregion
export { resolveManifestContractPluginIdsByCompatibilityRuntimePath as a, resolveEffectivePluginActivationState as c, isBundledChannelEnabledByChannelConfig$1 as d, normalizePluginsConfigWithResolver$1 as f, resolveMemorySlotDecisionShared as h, resolveManifestContractPluginIds as i, resolveMemorySlotDecision as l, resolveEnableStateShared as m, loadPluginManifestRegistry as n, hasExplicitPluginConfig as o, resolveEnableStateResult as p, resolveManifestContractOwnerPluginId as r, normalizePluginsConfigWithResolver as s, clearPluginManifestRegistryCache as t, hasExplicitPluginConfig$1 as u };
