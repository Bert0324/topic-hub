...
function createIdentityFromEnsure(params) {
	const acpxRecordId = normalizeOptionalString(params.handle.acpxRecordId);
	const acpxSessionId = normalizeOptionalString(params.handle.backendSessionId);
	const agentSessionId = normalizeOptionalString(params.handle.agentSessionId);
