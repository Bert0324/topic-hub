...
import { S as AUTH_STORE_LOCK_OPTIONS, T as log, _ as areOAuthCredentialsEquivalent, h as resolveAuthStorePath, l as saveAuthProfileStore, n as ensureAuthProfileStore, p as ensureAuthStoreFile, s as loadAuthProfileStoreForSecretsRuntime, v as readManagedExternalCliCredential, x as writeCodexCliCredentials } from "./store-CJsXfApK.js";
import { n as resolveAuthProfileMetadata } from "./identity-BxWG53Lz.js";
import { i as formatProviderAuthProfileApiKeyWithPlugin, n as buildProviderAuthDoctorHintWithPlugin, o as refreshProviderOAuthCredentialWithPlugin } from "./provider-runtime.runtime-BL5Bb-2f.js";
import { i as withFileLock } from "./file-lock-3J282YN4.js";
import "./file-lock-D5A4FaLu.js";
import { i as resolveSecretRefString } from "./resolve-CFv83bZp.js";
import { a as refreshChutesTokens } from "./chutes-oauth-BAgkcNxZ.js";
import { h as resolveTokenExpiryState } from "./order-Co3gVz_f.js";
import { t as assertNoOAuthSecretRefPolicyViolations } from "./policy-DB_LGQ-q.js";
import "./profiles-B5JpuCYg.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-Dw8rPn8T.js";
		...
		if (externallyManaged) {
			...
			if (externallyManaged.managedBy === "codex-cli") {
				...
				if (pluginRefreshed) {
					...
					if (!writeCodexCliCredentials(refreshedCredentials)) log.warn("failed to persist refreshed codex credentials back to Codex storage", { profileId: params.profileId });
...
//#endregion
export { formatAuthDoctorHint as n, resolveAuthProfileDisplayLabel as r, resolveApiKeyForProfile as t };
