...
import "./format-DBsn9Eac.js";
import { l as buildStatusOverviewRowsFromSurface } from "./status-runtime-shared-Cs7XQhnR.js";
import { n as statusChannelsTableColumns, t as buildStatusChannelsTableRows } from "./channels-table-B-0prYeS.js";
...
function buildStatusAgentsValue(params) {
	const pending = params.agentStatus.bootstrapPendingCount > 0 ? `${params.agentStatus.bootstrapPendingCount} bootstrap file${params.agentStatus.bootstrapPendingCount === 1 ? "" : "s"} present` : "no bootstrap files";
...
function buildStatusChannelsSection(params) {
	return {
		...
		width: params.width,
		renderTable: params.renderTable,
		columns: statusChannelsTableColumns.map((column) => column.key === "Detail" ? {
			...column,
			minWidth: 28
		} : column),
...
//#endregion
export { statusHealthColumns as S, buildStatusPluginCompatibilityLines as _, buildStatusChannelsSection as a, buildStatusSystemEventsRows as b, buildStatusOverviewSection as c, buildStatusUsageSection as d, buildStatusAllOverviewRows as f, buildStatusPairingRecoveryLines as g, buildStatusHealthRows as h, buildStatusChannelDetailsSections as i, buildStatusSessionsSection as l, buildStatusFooterLines as m, appendStatusSectionHeading as n, buildStatusChannelsTableSection as o, buildStatusCommandOverviewRows as p, buildStatusAgentsSection as r, buildStatusHealthSection as s, appendStatusReportSections as t, buildStatusSystemEventsSection as u, buildStatusSecurityAuditLines as v, buildStatusSystemEventsTrailer as x, buildStatusSessionsRows as y };
