...
import { i as projectSafeChannelAccountSnapshotFields } from "./account-snapshot-fields-eaL__bE4.js";
...
async function buildSnapshotFromAccount(params) {
	if (params.plugin.status?.buildAccountSnapshot) {
		...
		return normalizeOptionalString(snapshot.accountId) ? snapshot : {
			...snapshot,
