...
import { T as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BsyvYleM.js";
import { r as buildExecApprovalActionDescriptors } from "./exec-approval-reply-pE74J4oY.js";
import "./approval-gateway-resolver-_uVmmbZs.js";
import { t as createChannelNativeApprovalRuntime } from "./approval-native-runtime-CxFt9X1s.js";
import { t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BXJrbysg.js";
...
function buildPendingApprovalView(request) {
	if (request.id.startsWith("plugin:")) {
		...
		return {
			...
			actions: buildExecApprovalActionDescriptors({ approvalCommandId: pluginRequest.id }),
