...
import { c as normalizeOptionalStringifiedId, d as readStringValue, i as normalizeLowercaseStringOrEmpty, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
import { o as normalizeChannelId } from "./registry-BRjSWImW.js";
import { b as truncateUtf16Safe, l as isRecord, m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { r as redactSensitiveText, t as getDefaultRedactPatterns } from "./redact-uK0bEIef.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { t as sanitizeForLog } from "./ansi-Dm9DlII5.js";
import { x as readLoggingConfig } from "./logger-DO8SAv56.js";
import { t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { t as redactIdentifier } from "./redact-identifier-D1My7blH.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-DiVqdPR8.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-CZL2P3ko.js";
import { C as parseThreadSessionSuffix, c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { n as normalizeAccountId } from "./account-id-BMe6W-KZ.js";
import { t as logDebug } from "./logger-tSqm_V4O.js";
import { b as resolveSessionAgentIds, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, s as resolveAgentExecutionContract, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { C as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, D as describeSessionsSendTool, E as describeSessionsListTool, O as describeSessionsSpawnTool, S as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, T as describeSessionsHistoryTool, b as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, h as CRON_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, v as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, w as describeSessionStatusTool, x as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, y as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DekfzodU.js";
import { a as loadConfig, m as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-CIh0_WgN.js";
import { r as resolveManifestContractOwnerPluginId } from "./manifest-registry--_2x2rrY.js";
...
import { t as getProviderEnvVars } from "./provider-env-vars-CxcCP7jM.js";
import { t as parseDurationMs } from "./parse-duration-DOBbb8_k.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-k9_Rf40t.js";
import "./config-_X90biGc.js";
import { a as trySafeFileURLToPath } from "./local-file-access-Ca-kBh7-.js";
import { n as assertSandboxPath } from "./sandbox-paths-BpWrwuiS.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-COx_cS2e.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DQgMr1Hj.js";
import { d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BsZYykgY.js";
import "./plugins-C60yWwZy.js";
import "./delivery-context-DfqDfkC4.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-DQ7nEKWW.js";
import { b as normalizeProviderTransportWithPlugin } from "./provider-runtime-ljZXzW8q.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DGmN5e8M.js";
import { n as ensureAuthProfileStore, o as loadAuthProfileStoreForRuntime } from "./store-CJsXfApK.js";
import { f as resolveProfilesUnavailableReason, n as resolveAuthProfileOrder, o as getSoonestCooldownExpiry, s as isProfileInCooldown } from "./order-Co3gVz_f.js";
import { E as normalizeModelRef, T as modelKey, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, n as buildConfiguredAllowlistKeys, t as buildAllowedModelSet } from "./model-selection-DYo_mceY.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-BLkxgcMR.js";
import { r as getApiKeyForModel } from "./model-auth--xFDcZHC.js";
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-CWBlFfyo.js";
import { a as listChannelSupportedActions, d as resolvePluginTools, r as listAllChannelSupportedActions } from "./channel-tools-BYS-KHaL.js";
import { i as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-ydBtqQqj.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CDyGaBO4.js";
...
import { t as extractDeliveryInfo } from "./sessions-axRgTD70.js";
import { n as resolveSessionConversationRef } from "./session-conversation-D0x0jUff.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { f as resolveSessionModelIdentityRef } from "./session-utils-nUaAb7Y3.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-BqNJ-U8P.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-BwgrIC7s.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-BY3E3Z_p.js";
import { w as textToSpeech } from "./tts-Dz_UY2jH.js";
import { E as isLikelyContextOverflowError, g as classifyProviderRuntimeFailureKind } from "./pi-embedded-helpers-x9Tf7Zu1.js";
import { i as parseApiErrorInfo } from "./assistant-error-format-CpocaYYo.js";
import { d as stableStringify, o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-DVLttSO5.js";
import { a as getImageMetadata } from "./image-ops-DsdEQcvT.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BG8bgK9t.js";
import { a as isTimeoutError, i as isFailoverError, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-Dvvg9Pjq.js";
import { _ as resolveWorkspaceRoot, b as toRelativeWorkspacePath, g as normalizeWorkspaceDir, x as parseReplyDirectives } from "./deliver-BfVgOanr.js";
import { t as extractTextFromChatContent } from "./chat-content-CP_kYlOD.js";
import { t as extractAssistantText } from "./pi-embedded-utils-DwSDy8XV.js";
import { r as callGateway } from "./call-e1uIKGwS.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-CqmjNIs4.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BeBZlMTt.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-Co_6GYrb.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-Bwj7zIPh.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CIz4rmTW.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BQzxj076.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-DVwwl5ln.js";
import { r as stripToolMessages } from "./chat-history-text-PVIH3zCk.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-rzOQNCQW.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Bgfqr3vS.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-C0wcNwPM.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DHFaZf7J.js";
import { c as TrimmedNonEmptyStringFieldSchema, l as parseDeliveryInput, s as TimeoutSecondsFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-D27-oEZX.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-B1zSykOp.js";
import { n as formatDoctorNonInteractiveHint, s as writeRestartSentinel } from "./restart-sentinel-BdmzhfrL.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-7XyXWA28.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C3-Pp5ur.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DLYXsMv7.js";
import { l as saveMediaBuffer } from "./store-BqmRfmaG.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-Wpl2WQZ0.js";
import { r as getDefaultLocalRoots } from "./local-media-access-CGuXCkg0.js";
import { a as coerceImageModelConfig, c as buildToolModelConfigFromCandidates, d as hasToolModelConfig, f as resolveDefaultModelRef, l as coerceToolModelConfig, n as isMinimaxVlmProvider, o as decodeDataUrl, s as resolveProviderVisionModelFromConfig, u as hasAuthForProvider } from "./minimax-vlm-DyC3kkBI.js";
import { C as getMediaUnderstandingProvider, E as resolveBundledDefaultMediaModel, T as resolveBundledAutoMediaKeyProviders, b as resolveAutoMediaKeyProviders, w as bundledProviderSupportsNativePdfDocument, x as resolveDefaultMediaModel } from "./resolve-DaZaZLcz.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BhQHohaR.js";
import { t as buildProviderRegistry } from "./runner-ADcSh0Jv.js";
import "./media-understanding-BmvKf4MA.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BslJPO6o.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-mWCsIYwb.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-Dj7Ke-sq.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-B96PuGKj.js";
import { c as POLL_CREATION_PARAM_DEFS, l as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, t as getToolResult } from "./message-action-runner-DV3g6Yqp.js";
import { t as sendMessage } from "./message-D8iggNDu.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-B3kpZg8Y.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-CAJetOiZ.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Cjgc0jkv.js";
import { f as listTasksForOwnerKey } from "./task-registry-B_vC9pQf.js";
import "./runtime-internal-C6buikQk.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId, s as recordTaskRunProgressByRunId } from "./task-executor-DTBvc_JV.js";
import "./task-registry-delivery-runtime-troRW9nt.js";
import { C as isAnnounceSkip, O as deliverSubagentAnnouncement, S as REPLY_SKIP_TOKEN, T as AGENT_LANE_NESTED, b as runAgentStep, d as registerSubagentRun, k as formatAgentInternalEventsForPrompt, w as isReplySkip, x as ANNOUNCE_SKIP_TOKEN } from "./subagent-registry-C98AJ7CF.js";
import { t as parseTimeoutMs } from "./parse-timeout-DQm4UYYW.js";
import { t as extractPdfContent } from "./pdf-extract-Do5z2J53.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-3zqh1Vwn.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-BG1Bt-6s.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-D3KG2h6j.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CjStrN8l.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Bp6Uv68V.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-s7JvUgIu.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-CXp3RPM3.js";
import { c as wrapWebContent, s as wrapExternalContent } from "./external-content-CAN4Pl3f.js";
import { t as resolvePluginWebFetchProviders } from "./web-fetch-providers.runtime-hZUSc9NC.js";
import { a as runWebSearch, c as readWebProviderEnvValue, i as resolveWebSearchDefinition, l as resolveWebProviderConfig, o as hasWebProviderEntryCredential, s as providerRequiresCredential, u as resolveWebProviderDefinition } from "./runtime-qjg_Huy6.js";
import { _ as truncateText$1, a as readResponseText, g as markdownToText, h as htmlToMarkdown, i as readCache, l as writeCache, m as extractReadableContent, o as resolveCacheTtlMs, p as extractBasicHtmlContent, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-cBm1oRxe.js";
import "./web-search-provider-common-BcImcdEq.js";
...
function resolveEditPath(root, pathParam) {
	const expanded = pathParam.startsWith("~/") || pathParam === "~" ? pathParam.replace(/^~/, os.homedir()) : pathParam;
...
function resolveToolPathAgainstWorkspaceRoot(params) {
	...
	return path.isAbsolute(candidate) ? path.resolve(candidate) : path.resolve(params.root, candidate || ".");
}
...
function assertGatewayConfigMutationAllowed(params) {
	...
	if (changedProtectedPaths.length === 0) return;
...
const log$4 = createSubsystemLogger("model-fallback");
/**
...
function resolveFallbackSoonestCooldownExpiry(params) {
	if (!params.authStore) return null;
	...
	for (const candidate of params.candidates) {
		const candidateSoonest = getSoonestCooldownExpiry(refreshedStore, resolveAuthProfileOrder({
			cfg: params.cfg,
...
async function runWithModelFallback(params) {
	...
	for (let i = 0; i < candidates.length; i += 1) {
		...
		if (authStore) {
			...
			const isAnyProfileAvailable = profileIds.some((id) => !isProfileInCooldown(authStore, id, void 0, candidate.model));
		...
		if ("success" in attemptRun) {
			...
			if (notFoundAttempt) log$4.warn(`Model "${sanitizeForLog(notFoundAttempt.provider)}/${sanitizeForLog(notFoundAttempt.model)}" not found. Fell back to "${sanitizeForLog(candidate.provider)}/${sanitizeForLog(candidate.model)}".`);
...
function resolveModelFromRegistry(params) {
	...
	if (!model) throw new Error(`Unknown model: ${params.provider}/${params.modelId}`);
	return model;
}
...
function pickConfiguredMediaMaxBytes(cfg) {
...
function createImageGenerateTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const savedImages = await Promise.all(result.images.map((image) => saveMediaBuffer(image.buffer, image.mimeType, "tool-image-generation", void 0, filename || image.fileName)));
...
async function executeMusicGenerationJob(params) {
	...
	const savedTracks = await Promise.all(result.tracks.map((track) => saveMediaBuffer(track.buffer, track.mimeType, "tool-music-generation", void 0, params.filename || track.fileName)));
	const ignoredOverrides = result.ignoredOverrides ?? [];
...
const COMMANDS_STATUS_RUNTIME_SPEC = ["../../auto-reply/reply/commands-status.runtime", ".js"];
let commandsStatusRuntimePromise = null;
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= importRuntimeModule(import.meta.url, COMMANDS_STATUS_RUNTIME_SPEC);
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-DlQ8xI7I.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-BIJO0grN.js");
...
async function executeVideoGenerationJob(params) {
	...
	const savedVideos = await Promise.all(bufferVideos.map((video) => saveMediaBuffer(video.buffer, video.mimeType, "tool-video-generation", void 0, params.filename || video.fileName)));
...
function resolveFetchConfig$1(config) {
...
function isWebFetchProviderConfigured(params) {
	return hasEntryCredential(params.provider, params.config, resolveFetchConfig$1(params.config));
}
...
//#endregion
export { buildApiErrorObservationFields as A, createSandboxedReadTool as C, wrapToolWorkspaceRootGuardWithOptions as D, wrapToolWorkspaceRootGuard as E, isStrictAgenticExecutionContractActive as O, createSandboxedEditTool as S, wrapToolMemoryFlushAppendOnlyWrite as T, assertSafeCronSessionTargetId as _, buildActiveVideoGenerationTaskPromptContextForSession as a, createHostWorkspaceWriteTool as b, resolveSandboxedBridgeMediaPath as c, LiveSessionModelSwitchError as d, shouldAllowCooldownProbeForReason as f, normalizeCronJobPatch as g, normalizeCronJobInput as h, resolveWebFetchDefinition as i, buildTextObservationFields as j, isStrictAgenticSupportedProviderModel as k, isFallbackSummaryError as l, normalizeCronJobCreate as m, isWebFetchProviderConfigured as n, buildActiveMusicGenerationTaskPromptContextForSession as o, normalizeHttpWebhookUrl as p, listWebFetchProviders as r, createSandboxBridgeReadFile as s, createOpenClawTools as t, runWithModelFallback as u, isInvalidCronSessionTargetIdError as v, createSandboxedWriteTool as w, createOpenClawReadTool as x, createHostWorkspaceEditTool as y };
