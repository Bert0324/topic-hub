import { i as normalizeLowercaseStringOrEmpty, r as lowercasePreservingWhitespace } from "./string-coerce-D8LAEut5.js";
//#region src/memory-host-sdk/host/multimodal.ts
...
function buildCaseInsensitiveExtensionGlob(extension) {
	...
	return `*.${Array.from(normalized, (char) => {
		return `[${lowercasePreservingWhitespace(char)}${char.toUpperCase()}]`;
	}).join("")}`;
}
