import { h as parseLooseIpAddress, i as isCanonicalDottedDecimalIPv4, l as isLegacyIpv4Literal, m as parseCanonicalIpAddress, n as isBlockedSpecialUseIpv4Address, r as isBlockedSpecialUseIpv6Address, s as isIpv4Address, t as extractEmbeddedIpv4FromIpv6 } from "./ip-CqT8RkYB.js";
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-GfEvoPl0.js";
import { t as normalizeHostname } from "./hostname-DBv2A1pF.js";
import "node:module";
...
function createPinnedDispatcher(pinned, policy, ssrfPolicy) {
	...
	if (!policy || policy.mode === "direct") return createHttp1Agent({ connect: withPinnedLookup(lookup, policy?.connect) });
	...
	if (!requestTls) return createHttp1ProxyAgent({ uri: proxyUrl });
...
//#endregion
export { createPinnedLookup as a, isHostnameAllowedByPattern as c, matchesHostnameAllowlist as d, normalizeHostnameAllowlist as f, ssrf_exports as h, createPinnedDispatcher as i, isPrivateIpAddress as l, resolvePinnedHostnameWithPolicy as m, assertPublicHostname as n, isBlockedHostname as o, resolvePinnedHostname as p, closeDispatcher as r, isBlockedHostnameOrIp as s, SsrFBlockedError as t, isPrivateNetworkAllowedByPolicy as u };
