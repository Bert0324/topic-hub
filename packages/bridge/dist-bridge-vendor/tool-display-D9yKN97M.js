...
import { g as shortenHomeInString } from "./utils-BpVTx0yp.js";
import { i as redactToolDetail } from "./redact-uK0bEIef.js";
import { r as asOptionalObjectRecord } from "./record-coerce-zl3pijE0.js";
...
function resolveExecDetail(args) {
	...
	if (compact && compact !== displaySummary && compact !== summary) return `${displaySummary} · \`${compact}\``;
