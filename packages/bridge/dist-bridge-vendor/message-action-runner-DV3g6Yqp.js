...
import { n as basenameFromMediaSource } from "./local-file-access-Ca-kBh7-.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-BpWrwuiS.js";
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, r as isDeliverableMessageChannel } from "./message-channel-BsZYykgY.js";
import "./plugins-C60yWwZy.js";
import { a as actionHasTarget, o as actionRequiresTarget, r as applyTargetToParams } from "./channel-target-D3d-fzsn.js";
import { u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { i as recordSessionMetaFromInbound } from "./store-CZFUytbr.js";
import "./sessions-axRgTD70.js";
import { t as appendAssistantMessageToSessionTranscript } from "./transcript-CxvrT_cw.js";
import { n as extensionForMime } from "./mime-BY3E3Z_p.js";
import { l as throwIfAborted, u as resolveAgentScopedOutboundMediaAccess, x as parseReplyDirectives } from "./deliver-BfVgOanr.js";
import { a as looksLikeTargetId, c as normalizeTargetForProvider, i as buildTargetResolverSignature, l as resolveNormalizedTargetInput, o as maybeResolvePluginMessagingTarget, s as normalizeChannelTargetInput } from "./reply-payloads-dedupe-mHIFb5V8.js";
import { d as readNumberParam, h as readStringParam, p as readStringArrayParam, y as readSnakeCaseParamRaw } from "./common-CqmjNIs4.js";
import { a as createRootScopedReadFile } from "./fs-safe-Co_6GYrb.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-Bgfqr3vS.js";
import { t as loadWebMedia } from "./web-media-Wpl2WQZ0.js";
import { i as hasReplyPayloadContent, t as hasInteractiveReplyBlocks } from "./payload-3OXuvJHe.js";
import { r as resolvePollMaxSelections } from "./polls-Bhfg-fwI.js";
import { t as buildChannelAccountBindings } from "./bindings-BbxbSOFG.js";
import { n as resolveOutboundChannelPlugin$1 } from "./channel-resolution-CHQQyshp.js";
import { n as resolveMessageChannelSelection, t as listConfiguredMessageChannels } from "./channel-selection-3h0MF4q1.js";
import { n as resolveOutboundMediaAccess, t as buildOutboundMediaLoadOptions } from "./load-options-BqrJzxbH.js";
import { t as readBooleanParam$1 } from "./boolean-param-B2va313b.js";
import { r as unknownTargetError, t as ambiguousTargetError } from "./target-errors-D4ghhyQ_.js";
import { n as sendPoll, t as sendMessage } from "./message-D8iggNDu.js";
import { t as extractToolPayload } from "./tool-payload-eHC4_XtG.js";
import "./inbound.runtime-CKkJgQbw.js";
import { t as buildAgentSessionKey } from "./resolve-route-bRTOhLms.js";
...
async function maybeResolveIdLikeTarget(params) {
	return asResolvedMessagingTarget(await maybeResolvePluginMessagingTarget({
		...params,
		requireIdLike: true
	}));
}
...
function loadMessageActionGatewayRuntime() {
	messageActionGatewayRuntimePromise ??= import("./message.gateway.runtime-B9zmbeDP.js");
...
function collectActionMediaSourceHints(params) {
	const sources = [];
	for (const key of [
		"media",
		"mediaUrl",
		...
		const source = typeof params[key] === "string" ? params[key] : void 0;
		if (normalizeOptionalString(source) && source) sources.push(source);
	}
	return sources;
}
...
async function handleSendAction(ctx) {
	...
	const hasBlocks = Array.isArray(params.blocks) && params.blocks.length > 0 || typeof params.blocks === "string" && params.blocks.trim().length > 0;
	const caption = readStringParam(params, "caption", { allowEmpty: true }) ?? "";
	let message = readStringParam(params, "message", {
		required: !mediaHint && !hasButtons && !hasCard && !hasComponents && !hasInteractive && !hasBlocks,
		allowEmpty: true
	}) ?? "";
	...
	}, { extraContent: hasButtons || hasCard || hasComponents || hasBlocks })) throw new Error("send requires text or media");
	params.message = message;
...
async function handlePluginAction(ctx) {
	...
	if (!plugin?.actions?.handleAction) throw new Error(`Channel ${channel} is unavailable for message actions (plugin not loaded).`);
	if ((plugin.actions.resolveExecutionMode?.({ action }) ?? "local") === "gateway" && gateway) return {
		kind: "action",
		channel,
		action,
		handledBy: "plugin",
...
//#endregion
export { formatTargetDisplay as a, POLL_CREATION_PARAM_DEFS as c, resolveOutboundSessionRoute as i, SHARED_POLL_CREATION_PARAM_NAMES as l, runMessageAction as n, maybeResolveIdLikeTarget as o, ensureOutboundSessionEntry as r, resetDirectoryCache as s, getToolResult as t, dispatchChannelMessageAction as u };
