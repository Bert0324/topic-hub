...
function createHookRunner(registry, options = {}) {
	...
	*/
	async function runBeforeAgentStart(event, ctx) {
		return runModifyingHook("before_agent_start", event, ctx, { mergeResults: (acc, next) => ({
...
//#endregion
export { resetGlobalHookRunner as a, initializeGlobalHookRunner as i, getGlobalPluginRegistry as n, runGlobalGatewayStopSafely as o, hasGlobalHooks as r, joinPresentTextSegments as s, getGlobalHookRunner as t };
