...
import { i as getChildLogger, y as normalizeLogLevel } from "./logger-DO8SAv56.js";
import { t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-Cch7Xix1.js";
import { a as shouldLogVerbose } from "./globals-DiVqdPR8.js";
...
import { d as ensureAgentWorkspace } from "./workspace-LfA0pl0B.js";
import { a as resolveAgentDir, m as resolveAgentWorkspaceDir } from "./agent-scope-D2A6iYD-.js";
import { a as loadConfig, h as writeConfigFile } from "./io-CIh0_WgN.js";
...
import { n as requestHeartbeatNow } from "./heartbeat-wake-DlLYbFOv.js";
...
import { a as chunkText, c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, o as chunkTextWithMode, r as chunkMarkdownText, s as resolveChunkMode, t as chunkByNewline } from "./chunk-Nshu4GGn.js";
import { t as convertMarkdownTables } from "./tables-aSo-9oPM.js";
import { x as resolveThinkingDefault } from "./model-selection-DYo_mceY.js";
import { i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { i as resolveHumanDelayConfig, n as resolveAgentIdentity, r as resolveEffectiveMessagesConfig } from "./identity-B3n7EZ4K.js";
import { i as recordSessionMetaFromInbound, o as saveSessionStore, r as readSessionUpdatedAt, s as updateLastRoute } from "./store-CZFUytbr.js";
...
import { h as mediaKindFromMime, t as detectMime } from "./mime-BY3E3Z_p.js";
import { a as getImageMetadata, l as resizeToJpeg } from "./image-ops-DsdEQcvT.js";
import { l as onAgentEvent } from "./agent-events-L3WabTAF.js";
import { n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-CL46Q9UY.js";
...
import { t as loadWebMedia } from "./web-media-Wpl2WQZ0.js";
import { n as fetchRemoteMedia } from "./fetch-v6OD_1d1.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-LemWswm1.js";
import { t as loadChannelOutboundAdapter } from "./load-DTm4Wyb4.js";
import { i as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-bRTOhLms.js";
import { n as listRuntimeMusicGenerationProviders, t as generateMusic } from "./runtime-B3kpZg8Y.js";
import { D as failFlow, I as resumeFlow, L as setFlowWaiting, P as requestFlowCancel, d as listTasksForFlowId, k as finishFlow, t as cancelTaskById, w as createManagedTaskFlow } from "./task-registry-B_vC9pQf.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-B-el_8bQ.js";
import "./runtime-internal-C6buikQk.js";
import { c as runTaskInFlowForOwner, d as findLatestTaskFlowForOwner, f as getTaskFlowByIdForOwner, m as resolveTaskFlowForLookupTokenForOwner, n as cancelFlowByIdForOwner, o as getFlowTaskSummary, p as listTaskFlowsForOwner } from "./task-executor-DTBvc_JV.js";
import { a as listTasksForRelatedSessionKeyForOwner, i as getTaskByIdForOwner, n as findLatestTaskForRelatedSessionKeyForOwner, o as resolveTaskForLookupTokenForOwner } from "./task-owner-access-3zqh1Vwn.js";
import { t as resolveAgentTimeoutMs } from "./timeout-oGay3Wrd.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-s7JvUgIu.js";
import { a as runWebSearch, r as listWebSearchProviders } from "./runtime-qjg_Huy6.js";
import { i as shouldComputeCommandAuthorized, r as isControlCommandMessage, t as hasControlCommand } from "./command-detection-DhgQg6DG.js";
import { f as shouldHandleTextCommands } from "./commands-registry-Cpq8HdKx.js";
import { a as createReplyDispatcherWithTyping, l as withReplyDispatcher, s as dispatchReplyFromConfig } from "./dispatch-n5iezYg-.js";
import { t as finalizeInboundContext } from "./inbound-context-c_JsnFSS.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope, t as formatAgentEnvelope } from "./envelope-DZCk5rI5.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-Divaj66n.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-Cb-cUToG.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-CsNghp8O.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-CffE70GH.js";
import { t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-sDA7dbZv.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-Ci0K0XaN.js";
...
import { t as recordInboundSession } from "./session-BlEms5TT.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CJk0I8mc.js";
import { n as recordChannelActivity, t as getChannelActivity } from "./channel-activity-CeCNSCz9.js";
import { t as buildPairingReply } from "./pairing-messages-B0vBO03D.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-Bb-XVaPT.js";
import { i as isVoiceCompatibleAudio } from "./audio-CymPTR_6.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-WmMO--82.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-DO5iK5KE.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./tts-7l8E0BjO.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CC8klnuC.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-UZc4fKcq.js"));
