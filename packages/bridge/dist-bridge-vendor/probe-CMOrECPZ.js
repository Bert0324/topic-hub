...
import { l as READ_SCOPE } from "./method-scopes-CzgTst__.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		...
		try {
			const { loadOrCreateDeviceIdentity } = await import("./device-identity-BQI4ecWB.js");
