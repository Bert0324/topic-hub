import { r as isPidAlive, t as resolveProcessScopedMap } from "./process-scoped-map-BIyb6oMT.js";
...
async function drainAllLocks() {
	for (const [normalizedFile, held] of Array.from(HELD_LOCKS.entries())) {
		...
		await fs$1.rm(held.lockPath, { force: true }).catch(() => void 0);
	}
}
...
//#endregion
export { withFileLock as i, drainFileLockStateForTest as n, resetFileLockStateForTest as r, acquireFileLock as t };
