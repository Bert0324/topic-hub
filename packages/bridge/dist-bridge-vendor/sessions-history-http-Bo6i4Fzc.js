...
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-CzgTst__.js";
...
import { d as resolveGatewaySessionStoreTarget, l as resolveFreshestSessionEntryFromStoreKeys } from "./session-utils-nUaAb7Y3.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BqNJ-U8P.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-CcRatL9v.js";
import { S as setSseHeaders, a as getHeader, b as sendMethodNotAllowed, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, v as sendInvalidRequest, y as sendJson } from "./http-utils-B8zBCncg.js";
import { r as sanitizeChatHistoryMessages, t as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS } from "./chat-D6vDCM0_.js";
...
function buildSessionHistorySnapshot(params) {
	const history = paginateSessionMessages(toSessionHistoryMessages(sanitizeChatHistoryMessages(params.rawMessages, params.maxChars ?? 12e3)), params.limit, params.cursor);
...
var SessionHistorySseState = class SessionHistorySseState {
	...
	constructor(params) {
		...
		this.maxChars = params.maxChars ?? 12e3;
	...
	appendInlineMessage(update) {
		...
		this.sentHistory = buildPaginatedSessionHistory({
			messages: [...this.sentHistory.messages, sanitizedMessage],
			hasMore: false
		});
		return {
