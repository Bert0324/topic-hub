...
import { t as CONFIG_DIR } from "./utils-BpVTx0yp.js";
...
import { i as normalizeScpRemotePath, r as normalizeScpRemoteHost } from "./scp-host-CdzuE0ns.js";
...
import { i as copyFileWithinRoot, t as SafeOpenError } from "./fs-safe-Co_6GYrb.js";
import { s as getMediaDir, t as MEDIA_MAX_BYTES } from "./store-BqmRfmaG.js";
import { n as resolveChannelRemoteInboundAttachmentRoots } from "./channel-inbound-roots-D99I6_Mx.js";
...
async function stageSandboxMedia(params) {
	...
	const remoteAttachmentRoots = resolveChannelRemoteInboundAttachmentRoots({
		cfg,
		ctx
	}) ?? [];
	...
	for (const raw of rawPaths) {
		...
		try {
			...
			if (err instanceof SafeOpenError && err.code === "too-large") logVerbose(`Blocking inbound media staging above ${STAGED_MEDIA_MAX_BYTES} bytes: ${source}`);
