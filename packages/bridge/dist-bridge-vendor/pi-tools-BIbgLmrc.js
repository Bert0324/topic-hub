...
import { r as openBoundaryFile } from "./boundary-file-read-4GSqtybS.js";
import { b as isSubagentSessionKey } from "./session-key-CprbVBQX.js";
import { a as logWarn } from "./logger-tSqm_V4O.js";
import { i as resolveAgentConfig } from "./agent-scope-D2A6iYD-.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY, i as collectExplicitAllowlist, n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, u as resolveToolProfilePolicy } from "./tool-policy-DekfzodU.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CSYEt1lm.js";
import { n as assertSandboxPath } from "./sandbox-paths-BpWrwuiS.js";
import { f as resolveGatewayMessageChannel } from "./message-channel-BsZYykgY.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DGRh7BNn.js";
import { t as bindAbortRelay } from "./fetch-timeout-CpshsOTj.js";
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-BYS-KHaL.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-DG_k0X3j.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BG8bgK9t.js";
import { u as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-BSoPBIap.js";
import { _ as resolveWorkspaceRoot, f as resolveEffectiveToolPolicy, h as resolveSubagentToolPolicyForSession, p as resolveGroupToolPolicy, v as resolvePathFromInput, y as toRelativeSandboxPath } from "./deliver-BfVgOanr.js";
import { C as createSandboxedReadTool, D as wrapToolWorkspaceRootGuardWithOptions, E as wrapToolWorkspaceRootGuard, S as createSandboxedEditTool, T as wrapToolMemoryFlushAppendOnlyWrite, b as createHostWorkspaceWriteTool, t as createOpenClawTools, w as createSandboxedWriteTool, x as createOpenClawReadTool, y as createHostWorkspaceEditTool } from "./openclaw-tools-gljDkcq_.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-kkKlzrGI.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-DRUiV8Pk.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-Co_6GYrb.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-JbXMH9i6.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-KGmAd_zv.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-Bgfqr3vS.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-Dz8mawcv.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-Dz8mawcv.js");
...
function createOpenClawCodingTools(options) {
	...
	const subagentPolicy = isSubagentSessionKey(options?.sessionKey) && options?.sessionKey ? resolveSubagentToolPolicyForSession(options.config, options.sessionKey) : void 0;
...
//#endregion
export { resolveToolLoopDetectionConfig as n, createOpenClawCodingTools as t };
