...
import { a as resolveChannelEntryMatchWithFallback, n as buildChannelKeyCandidates, r as normalizeChannelSlug } from "./channel-config-DPi_Exnp.js";
import { t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { C as parseThreadSessionSuffix, S as parseRawSessionConversationRef } from "./session-key-CprbVBQX.js";
...
import { n as resolveSessionConversationRef, t as resolveSessionConversation } from "./session-conversation-D0x0jUff.js";
...
function resolveDirectChannelModelMatch(params) {
	...
	const directKeys = buildChannelKeyCandidates(params.groupId, ...buildGenericParentOverrideCandidates(params.parentSessionKey), ...normalizeOptionalLowercaseString(params.channel) === "feishu" ? buildFeishuParentOverrideCandidates(rawParent?.rawId) : []);
