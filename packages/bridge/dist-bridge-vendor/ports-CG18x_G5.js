...
import { s as isErrno } from "./errors-BTh8VBsl.js";
import { n as defaultRuntime } from "./runtime-DDp5sFCA.js";
import { a as shouldLogVerbose, n as info, s as warn, t as danger } from "./globals-DiVqdPR8.js";
...
import { t as resolveLsofCommand } from "./ports-lsof-Bcs-OsxK.js";
import { t as tryListenOnPort } from "./ports-probe-CZXPU9yp.js";
...
function buildPortHints(listeners, port) {
	...
	if (listeners.length > 1 && !isDualStackLoopbackGatewayListeners(listeners, port)) hints.push("Multiple listeners detected; ensure only one gateway/tunnel per port unless intentionally running isolated profiles.");
	return hints;
}
...
//#endregion
export { inspectPortUsage as a, isDualStackLoopbackGatewayListeners as c, handlePortError as i, describePortOwner as n, classifyPortListener as o, ensurePortAvailable as r, formatPortDiagnostics as s, PortInUseError as t };
