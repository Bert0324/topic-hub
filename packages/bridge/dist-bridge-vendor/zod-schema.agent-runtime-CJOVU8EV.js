...
import { C as SecretInputSchema, D as ToolsLinksSchema, O as ToolsMediaSchema, c as GroupChatSchema, d as HumanDelaySchema, f as IdentitySchema } from "./zod-schema.core-DabyC7aE.js";
...
const ToolsWebFetchSchema = z.object({
	...
	ssrfPolicy: z.object({ allowRfc2544BenchmarkRange: z.boolean().optional() }).strict().optional(),
	firecrawl: z.object({
		enabled: z.boolean().optional(),
		apiKey: SecretInputSchema.optional().register(sensitive),
...
const ToolsWebXSearchSchema = z.object({
	enabled: z.boolean().optional(),
	model: z.string().optional(),
...
const MemorySearchSchema = z.object({
	...
	qmd: z.object({ extraCollections: z.array(z.object({
		path: z.string(),
	...
	store: z.object({
		...
		fts: z.object({ tokenizer: z.union([z.literal("unicode61"), z.literal("trigram")]).optional() }).strict().optional(),
		vector: z.object({
			enabled: z.boolean().optional(),
...
const AgentEmbeddedHarnessSchema = z.object({
...
const AgentEntrySchema = z.object({
	...
	embeddedPi: z.object({ executionContract: z.union([z.literal("default"), z.literal("strict-agentic")]).optional() }).strict().optional(),
...
const ToolsSchema = z.object({
	...
	experimental: z.object({ planTool: z.boolean().optional() }).strict().optional()
}).strict().superRefine((value, ctx) => {
...
//#endregion
export { HeartbeatSchema as a, ToolsSchema as c, ElevatedAllowFromSchema as i, AgentModelSchema as l, AgentEntrySchema as n, MemorySearchSchema as o, AgentSandboxSchema as r, ToolPolicySchema as s, AgentEmbeddedHarnessSchema as t };
