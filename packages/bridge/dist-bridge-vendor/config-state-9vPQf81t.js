...
import { d as isBundledChannelEnabledByChannelConfig$1, f as normalizePluginsConfigWithResolver, h as resolveMemorySlotDecisionShared, m as resolveEnableStateShared, n as loadPluginManifestRegistry, p as resolveEnableStateResult, u as hasExplicitPluginConfig$1 } from "./manifest-registry--_2x2rrY.js";
...
function resolvePluginActivationState(params) {
	...
	if (params.origin === "workspace" && !explicitlyAllowed && entry?.enabled !== true && explicitSelection.cause !== "selected-context-engine-slot") return toPluginActivationState({
		enabled: false,
		activated: false,
		explicitlyEnabled: explicitSelection.explicitlyEnabled,
		source: "disabled",
	...
	if (params.config.slots.contextEngine === params.id) return toPluginActivationState({
		enabled: true,
		activated: true,
		explicitlyEnabled: true,
		source: "explicit",
