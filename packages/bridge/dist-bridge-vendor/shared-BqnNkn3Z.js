import { l as resolveProviderRequestPolicyConfig, n as buildProviderRequestDispatcherPolicy } from "./provider-request-config-DCwotaaa.js";
...
function resolveGuardedPostRequestOptions(params) {
	if (!params.allowPrivateNetwork && !params.dispatcherPolicy && params.pinDns === void 0 && !params.auditContext) return;
	return {
...
//#endregion
export { requireTranscriptionText as a, postTranscriptionRequest as i, fetchWithTimeoutGuarded as n, resolveProviderHttpRequestConfig as o, postJsonRequest as r, assertOkOrThrowHttpError as t };
