...
import { n as sha256HexPrefix } from "./redact-identifier-D1My7blH.js";
import { a as asRecord } from "./record-coerce-zl3pijE0.js";
...
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-eaL__bE4.js";
import { i as resolveChannelAccountEnabled, n as formatChannelAllowFrom, r as resolveChannelAccountConfigured, t as buildChannelAccountSnapshot } from "./account-summary-DrTTaCKm.js";
import "./format-DBsn9Eac.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-C7pg8dRY.js";
...
function summarizeTokenConfig(params) {
	...
	if (hasBotTokenField) {
		const unavailable = enabled.filter((a) => hasConfiguredUnavailableCredentialStatus(a.account));
		const ready = enabled.filter((a) => {
			const bot = normalizeOptionalString(asRecord(a.account).botToken) ?? "";
			return Boolean(bot);
		});
		if (unavailable.length > 0) return {
			state: "warn",
