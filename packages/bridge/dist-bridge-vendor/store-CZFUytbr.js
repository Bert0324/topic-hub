import { i as normalizeLowercaseStringOrEmpty, o as normalizeOptionalLowercaseString, s as normalizeOptionalString, u as normalizeStringifiedOptionalString } from "./string-coerce-D8LAEut5.js";
import { i as normalizeHyphenSlug } from "./string-normalization-DO5qgVap.js";
...
import { i as writeTextAtomic } from "./json-files-CyG5Q-51.js";
...
import { d as normalizeMessageChannel, u as listDeliverableMessageChannels } from "./message-channel-BsZYykgY.js";
...
import { n as isPrimarySessionTranscriptFileName, r as isSessionArchiveArtifactName } from "./artifacts-Buuio1qz.js";
import { t as normalizeChatType } from "./chat-type-CKHei6HV.js";
import { t as resolveConversationLabel } from "./conversation-label-CaAjhbRz.js";
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-6DEWydwn.js";
import { i as isSessionStoreCacheEnabled, l as getFileStatSnapshot, n as dropSessionStoreObjectCache, o as setSerializedSessionStore, r as getSerializedSessionStore, s as writeSessionStoreCache } from "./store-cache-CNiaIDn9.js";
import { n as normalizeSessionStore, t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { t as LOCK_QUEUES } from "./store-lock-state-CSX_RG15.js";
...
function resolveGroupSessionKey(ctx) {
	...
	const finalId = normalizeLowercaseStringOrEmpty(headIsSurface ? secondIsKind ? parts.slice(2).join(":") : parts.slice(1).join(":") : from);
...
//#endregion
export { resolveGroupSessionKey as S, deriveGroupSessionPatch as _, resolveSessionStoreEntry as a, snapshotSessionOrigin as b, updateSessionStore as c, getActiveSessionMaintenanceWarning as d, pruneStaleEntries as f, enforceSessionDiskBudget as g, rotateSessionFile as h, recordSessionMetaFromInbound as i, updateSessionStoreEntry as l, resolveMaintenanceConfigFromInput as m, normalizeStoreSessionKey as n, saveSessionStore as o, resolveMaintenanceConfig as p, readSessionUpdatedAt as r, updateLastRoute as s, archiveRemovedSessionTranscripts as t, capEntryCount as u, deriveSessionMetaPatch as v, buildGroupDisplayName as x, deriveSessionOrigin as y };
