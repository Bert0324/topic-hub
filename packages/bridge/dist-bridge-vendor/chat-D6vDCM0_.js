...
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-sTLdO-KP.js";
import { x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
...
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, i as isGatewayCliClient, l as isWebchatClient, m as GATEWAY_CLIENT_CAPS, t as INTERNAL_MESSAGE_CHANNEL, v as hasGatewayClientCap } from "./message-channel-BsZYykgY.js";
import { i as stripInlineDirectiveTagsFromMessageForDisplay, r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-DoZ1tyHd.js";
import { x as resolveThinkingDefault } from "./model-selection-DYo_mceY.js";
import { i as resolveSessionFilePath } from "./paths-CDyGaBO4.js";
import { _ as validateChatSendParams, g as validateChatInjectParams, h as validateChatHistoryParams, m as validateChatAbortParams, nn as ErrorCodes, rn as errorShape, t as formatValidationErrors } from "./protocol-BxYXhZGl.js";
import { a as normalizeInputProvenance } from "./input-provenance-CRnmC8r0.js";
import { o as ADMIN_SCOPE } from "./method-scopes-CzgTst__.js";
import "./sessions-axRgTD70.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DonV4dhV.js";
import { o as loadSessionEntry, p as resolveSessionModelRef, u as resolveGatewayModelSupportsImages } from "./session-utils-nUaAb7Y3.js";
import { c as stripEnvelopeFromMessages, i as readSessionMessages, l as jsonUtf8Bytes, n as capArrayByJsonBytes, s as stripEnvelopeFromMessage, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BqNJ-U8P.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-DJIhavaZ.js";
...
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CyOxx3eo.js";
import { i as resolveUserTimezone } from "./date-time-DUh5tyg7.js";
import { n as formatZonedTimestamp } from "./format-datetime-2pbIw2oA.js";
import { n as isAbortRequestText } from "./abort-primitives-B6RK1JTl.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-n5iezYg-.js";
import { n as resolveSendPolicy } from "./send-policy-Cw3tU_7b.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-A_Iw-WbM.js";
import { t as formatForLog } from "./ws-log-DUPGfHTv.js";
...
function resolveLocalAudioFileForEmbedding(raw) {
...
*/
function buildWebchatAudioContentBlocksFromReplyPayloads(payloads) {
...
function buildWebchatAudioOnlyAssistantMessage(payloads) {
...
const DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS = 12e3;
...
const chatHandlers = {
	...
	"chat.send": async ({ params, respond, context, client }) => {
		...
		try {
			...
			const appendWebchatAgentAudioTranscriptIfNeeded = (payload) => {
