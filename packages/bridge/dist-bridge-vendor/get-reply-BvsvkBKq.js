...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DO5qgVap.js";
import { a as normalizeAnyChannelId } from "./registry-BRjSWImW.js";
import { b as truncateUtf16Safe } from "./utils-BpVTx0yp.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BhKtFNS_.js";
...
import { t as getLoadedChannelPluginById } from "./registry-loaded-Cz9wJkqJ.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { r as logVerbose } from "./globals-DiVqdPR8.js";
import { i as generateSecureToken } from "./secure-random-BOfPlKTq.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-LfA0pl0B.js";
import { a as resolveAgentDir, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, n as listAgentEntries, p as resolveAgentSkillsFilter, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-DekfzodU.js";
import { a as loadConfig } from "./io-CIh0_WgN.js";
import "./defaults-BuTtS5Gf.js";
import { i as applyMergePatch } from "./schema-validator-s2bic7WL.js";
import "./config-_X90biGc.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-DQgMr1Hj.js";
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-BsZYykgY.js";
...
import { t as canonicalizeMainSessionAlias } from "./main-session-Cg1RPT_G.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DToSJrgK.js";
import { y as resetRegisteredAgentHarnessSessions } from "./loader-B-B7CN7x.js";
...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-DcBif8u5.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint } from "./thinking.shared-nRv_dCJ1.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-DYo_mceY.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-CRnmC8r0.js";
import { S as resolveGroupSessionKey, a as resolveSessionStoreEntry, c as updateSessionStore, m as resolveMaintenanceConfigFromInput, v as deriveSessionMetaPatch } from "./store-CZFUytbr.js";
import { t as normalizeChatType } from "./chat-type-CKHei6HV.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-6DEWydwn.js";
import { c as resolveThreadFlag, i as resolveChannelResetConfig, n as evaluateSessionFreshness, o as resolveSessionResetPolicy, s as resolveSessionResetType } from "./reset-CrFnICN4.js";
import { n as resolveSessionKey } from "./session-key-D1hYNyQB.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { t as resolveAndPersistSessionFile } from "./session-file-Vu5t83T7.js";
import { t as parseSessionThreadInfo } from "./thread-info-DiDjFCRt.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-mO9kfkwk.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BwgrIC7s.js";
...
import { i as supportsXHighThinking } from "./thinking-zRJA9LrI.js";
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-CXkvr7pD.js";
import { t as collectTextContentBlocks } from "./content-blocks-irFGQI8t.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-LemWswm1.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CpVrS909.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BWVQ1Iv3.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-C-NVQWds.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-B6RK1JTl.js";
import { t as hasControlCommand } from "./command-detection-DhgQg6DG.js";
import "./commands-registry-Cpq8HdKx.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-DiuhjL5-.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-Dgh55aU-.js";
import { t as finalizeInboundContext } from "./inbound-context-c_JsnFSS.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DZCk5rI5.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Cb-cUToG.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-yy9SfyLn.js";
import { t as resolveChannelModelOverride } from "./model-overrides-_YEC3Cri.js";
...
import { n as resolveBlockStreamingChunking } from "./block-streaming-B-CZG8t9.js";
import { t as resolveCommandAuthorization } from "./command-auth-DaLFIHjq.js";
import { t as buildCommandContext } from "./commands-context-HDbkiRes.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DlK16mJu.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CJiKkLGQ.js";
...
import { t as resolveStoredModelOverride } from "./stored-model-override-hGSbyeWA.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-vtZ0nw7d.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-wexiY-Hb.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-GEP3wtyT.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BhoZvfDj.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CSbb2ghC.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-CDaVFP4O.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-D3ht_CnS.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-Dem584XN.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-CZBF2Nlz.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-Cj6xoxZn.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-DV0tVxcg.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-SEJuqPeB.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-CWJOh36R.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-VPMrE5sH.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-C2QhqE36.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-CS203pro.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-CS203pro.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-CbmxMHtn.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-SMUyO9vi.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-BjJxScco.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-BjJxScco.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BrOU5yae.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CalRwWGH.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-C3mqIKsQ.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-B3h_q9a8.js");
...
async function runPreparedReply(params) {
	...
	const startupContextPrelude = isBareSessionReset && shouldApplyStartupContext({
		cfg,
	...
	const baseBodyFinal = isBareSessionReset ? buildBareSessionResetPrompt(cfg) : stripPromptThinkingDirectives(baseBody);
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-D7M2rEFW.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-CfgGk0Ku.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-DPf84bLd.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-ybCIzusQ.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-BI0irGsg.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-CO1tAY9S.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-B2aKntWG.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-DPGjQ-g0.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-D_gtWl3C.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-FpWPL9Kn.js");
