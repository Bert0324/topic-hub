...
import { u as listDeliverableMessageChannels } from "./message-channel-BsZYykgY.js";
import { n as resolveChannelApprovalCapability } from "./plugins-C60yWwZy.js";
import { t as buildMemoryPromptSection } from "./memory-state-jIh7Lh-v.js";
import { n as normalizeStructuredPromptSection, t as normalizePromptCapabilityIds } from "./prompt-cache-stability-YN6bAD57.js";
import { t as SYSTEM_PROMPT_CACHE_BOUNDARY } from "./system-prompt-cache-boundary-BmJyZc7M.js";
...
function buildAgentSystemPrompt(params) {
	...
	const inlineButtonsEnabled = new Set(runtimeCapabilities.map((cap) => normalizeLowercaseStringOrEmpty(cap)).filter(Boolean)).has("inlinebuttons");
...
//#endregion
export { sanitizeForPromptLiteral as n, wrapUntrustedPromptDataBlock as r, buildAgentSystemPrompt as t };
