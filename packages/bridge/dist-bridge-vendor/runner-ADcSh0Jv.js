import { i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
...
import { n as findNormalizedProviderValue } from "./provider-id-DDriY74A.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-k9_Rf40t.js";
import { i as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-Ca-kBh7-.js";
import { r as fetchWithTimeout } from "./fetch-timeout-CpshsOTj.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-BLkxgcMR.js";
import { a as hasAvailableAuthForProvider, s as resolveApiKeyForProvider } from "./model-auth--xFDcZHC.js";
import { d as sanitizeConfiguredProviderRequest, o as mergeProviderRequestOverrides } from "./provider-request-config-DCwotaaa.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-9wtELOal.js";
import { a as isAudioFileName, r as getFileExtension, s as kindFromMime, t as detectMime } from "./mime-BY3E3Z_p.js";
import { t as resolveSystemBin } from "./resolve-system-bin-ClgS6Uxc.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Bgfqr3vS.js";
import { n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-v6OD_1d1.js";
import { r as normalizeMediaProviderId } from "./entry-capabilities-yFOFhDsq.js";
import { C as getMediaUnderstandingProvider, S as buildMediaUnderstandingRegistry, _ as DEFAULT_VIDEO_MAX_BASE64_BYTES, a as resolvePrompt, b as resolveAutoMediaKeyProviders, g as DEFAULT_TIMEOUT_SECONDS, i as resolveModelEntries, n as resolveMaxBytes, o as resolveScopeDecision, r as resolveMaxChars, s as resolveTimeoutMs, u as CLI_OUTPUT_MAX_BUFFER, v as MIN_AUDIO_FILE_BYTES, x as resolveDefaultMediaModel } from "./resolve-DaZaZLcz.js";
import { t as describeImageWithModel } from "./image-runtime-BhQHohaR.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-D99I6_Mx.js";
import { t as buildRandomTempFilePath } from "./temp-download-DedZovWZ.js";
import "./temp-path-CHmDJDD2.js";
import "./shared-BqnNkn3Z.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CdoFB7Qw.js";
import { t as applyTemplate } from "./templating-CAOc_G4n.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-Cl5j45Zx.js";
...
var MediaAttachmentCache = class {
	...
	async readLocalBuffer(params) {
		...
		try {
			if (!(await handle.stat()).isFile()) throw new MediaUnderstandingSkipError("empty", `Attachment ${params.attachmentIndex + 1} has no path or URL.`);
			const canonicalPath = await fs$1.realpath(params.filePath).catch(() => params.filePath);
			if (!isInboundPathAllowed({
				filePath: canonicalPath,
				roots: await this.getCanonicalLocalPathRoots()
...
async function resolveProviderExecutionContext(params) {
	...
	return {
		...
		request: mergeProviderRequestOverrides(sanitizeConfiguredProviderRequest(params.config?.request), sanitizeConfiguredProviderRequest(params.entry.request))
	};
}
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
...
//#endregion
export { resolveAttachmentKind as S, MEDIA_FFPROBE_TIMEOUT_MS as _, runCapability as a, isAudioAttachment as b, findDecisionReason as c, parseFfprobeCsvFields as d, runFfmpeg as f, MEDIA_FFMPEG_TIMEOUT_MS as g, MEDIA_FFMPEG_MAX_BUFFER_BYTES as h, resolveMediaAttachmentLocalRoots as i, normalizeDecisionReason as l, MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS as m, clearMediaUnderstandingBinaryCacheForTests as n, createMediaAttachmentCache as o, runFfprobe as p, resolveAutoImageModel as r, normalizeMediaAttachments as s, buildProviderRegistry as t, parseFfprobeCodecAndSampleRate as u, MediaAttachmentCache as v, normalizeAttachments as x, isMediaUnderstandingSkipError as y };
