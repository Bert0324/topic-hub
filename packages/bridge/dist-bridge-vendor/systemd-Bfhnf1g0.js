...
import { f as resolveGatewayServiceDescription, n as resolveHomeDir, o as LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES, p as resolveGatewaySystemdServiceName } from "./paths-DzW4qw3w.js";
import { i as parseStrictPositiveInteger, n as parseStrictInteger } from "./parse-finite-number-CHVv_4FN.js";
import { a as splitArgsPreservingQuotes, i as writeFormattedLines, n as formatLine, r as toPosixPath, t as parseKeyValueOutput } from "./runtime-parse-BZLqix2U.js";
...
async function activateSystemdService(params) {
	const unitName = `${resolveGatewaySystemdServiceName(params.env.OPENCLAW_PROFILE)}.service`;
...
//#endregion
export { readSystemdServiceExecStart as a, restartSystemdService as c, uninstallLegacySystemdUnits as d, uninstallSystemdService as f, readSystemdUserLingerStatus as h, isSystemdUserServiceAvailable as i, stageSystemdService as l, enableSystemdUserLinger as m, isNonFatalSystemdInstallProbeError as n, readSystemdServiceRuntime as o, classifySystemdUnavailableDetail as p, isSystemdServiceEnabled as r, resolveSystemdUserUnitPath as s, installSystemdService as t, stopSystemdService as u };
