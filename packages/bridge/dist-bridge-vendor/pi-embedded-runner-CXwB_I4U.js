import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
import { g as shortenHomeInString, m as resolveUserPath } from "./utils-BpVTx0yp.js";
...
import { t as redactIdentifier } from "./redact-identifier-D1My7blH.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-sTLdO-KP.js";
import { t as isTruthyEnvValue } from "./env-D7g_ucIh.js";
import { n as sleepWithAbort } from "./backoff-gF8HX_ml.js";
import { i as generateSecureToken } from "./secure-random-BOfPlKTq.js";
import { n as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciStreamTimeouts } from "./undici-global-dispatcher-CMIbl3IO.js";
import { _ as resolveStateDir } from "./paths-D9v5qmRt.js";
import { b as isSubagentSessionKey, c as normalizeAgentId, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey, y as isCronSessionKey } from "./session-key-CprbVBQX.js";
import "./workspace-LfA0pl0B.js";
import { b as resolveSessionAgentIds, n as listAgentEntries, r as listAgentIds, s as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-D2A6iYD-.js";
import { l as normalizeToolName } from "./tool-policy-DekfzodU.js";
import { H as normalizeGoogleApiBaseUrl, at as resolveOwnerDisplaySetting } from "./io-CIh0_WgN.js";
import { r as normalizeProviderId } from "./provider-id-DDriY74A.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BuTtS5Gf.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-Bko9o5XK.js";
import { c as resolveSkillsPromptForRun } from "./skills-_RJJ480N.js";
import { t as parseBooleanValue } from "./boolean-MeICaci5.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-jnbPgR23.js";
import { d as normalizeMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BsZYykgY.js";
import { n as detectRuntimeShell } from "./supervisor-CIAB88Ar.js";
import { r as resolveExplicitAgentSessionKey } from "./main-session-Cg1RPT_G.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DToSJrgK.js";
import { i as resolveSessionLockMaxHoldFromTimeout, t as acquireSessionWriteLock } from "./session-write-lock-CCdFXL6G.js";
import { o as resolveSandboxContext } from "./sandbox-BJfRPwam.js";
import { r as parseFenceSpans } from "./fences-DJIUkd1X.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-DQ7nEKWW.js";
import { t as parseInlineDirectives } from "./directive-tags-DoZ1tyHd.js";
import { B as resolveProviderTextTransforms, C as prepareProviderRuntimeAuth, X as transformProviderSystemPrompt, nt as wrapStreamFnTextTransforms, z as resolveProviderSystemPromptContribution } from "./provider-runtime-ljZXzW8q.js";
import { v as listRegisteredAgentHarnesses } from "./loader-B-B7CN7x.js";
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-CWxC3y8-.js";
import { n as registerContextEngineForOwner, r as resolveContextEngine } from "./registry-CSroj6Lo.js";
import { n as ensureAuthProfileStore } from "./store-CJsXfApK.js";
import "./auth-profiles-1eTJwiqc.js";
import { f as resolveProfilesUnavailableReason, l as markAuthProfileFailure, n as resolveAuthProfileOrder, p as sanitizeForConsole, s as isProfileInCooldown, t as resolveAuthProfileEligibility, u as markAuthProfileUsed } from "./order-Co3gVz_f.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-D2Ih7kkl.js";
import { r as markAuthProfileGood } from "./profiles-B5JpuCYg.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel } from "./thinking.shared-nRv_dCJ1.js";
import { _ as resolvePersistedSelectedModelRef, c as normalizeStoredOverrideModel, f as resolveDefaultModelForAgent } from "./model-selection-DYo_mceY.js";
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth--xFDcZHC.js";
import { t as buildModelAliasLines } from "./model-alias-lines-B6rQe1vk.js";
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CHKL1orB.js";
import { c as resolveProviderRequestConfig, f as sanitizeRuntimeProviderRequestOverrides } from "./provider-request-config-DCwotaaa.js";
import { n as resolveModelAsync } from "./model-DLtFzYCE.js";
import { c as mergeTransportHeaders, d as buildGuardedModelFetch, t as registerProviderStreamForModel, u as sanitizeTransportPayloadText } from "./provider-stream-rZLdlDYf.js";
import { i as stripSystemPromptCacheBoundary, n as prependSystemPromptAdditionAfterCacheBoundary } from "./system-prompt-cache-boundary-BmJyZc7M.js";
import { t as parseGeminiAuth } from "./gemini-auth-CU5kYDpz.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-BYS-KHaL.js";
import { u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CutJw60p.js";
import { n as delegateCompactionToRuntime } from "./delegate-EdeLxn1P.js";
import { c as updateSessionStore } from "./store-CZFUytbr.js";
import "./sessions-axRgTD70.js";
import { i as resolveChannelResetConfig, n as evaluateSessionFreshness, o as resolveSessionResetPolicy, s as resolveSessionResetType } from "./reset-CrFnICN4.js";
import { n as resolveSessionKey } from "./session-key-D1hYNyQB.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { c as hasNonzeroUsage, l as makeZeroUsageSnapshot, o as derivePromptTokens, u as normalizeUsage } from "./chat-envelope-BvqqZK_b.js";
import { s as resolveAssistantMessagePhase } from "./chat-message-content-DJIhavaZ.js";
import { $ as createPreparedEmbeddedPiSettingsManager, A as buildEmbeddedExtensionFactories, B as resolveCompactionTimeoutMs, C as prewarmSessionFile, D as buildEmbeddedMessageActionDiscoveryInput, E as validateReplayTurns, G as guardSessionManager, H as readLastCacheTtlTimestamp, J as truncateOversizedToolResultsInSession, K as estimateToolResultReductionPotential, M as SAFETY_MARGIN, N as estimateMessagesTokens, O as getDmHistoryLimitFromSessionKey, Q as toClientToolDefinitions, S as resolveEmbeddedRunSkillEntries, T as sanitizeSessionHistory, U as resolveTranscriptPolicy, V as isCacheTtlEligibleProvider, W as shouldAllowProviderOwnedThinkingReplay, X as installToolResultContextGuard, Y as truncateOversizedToolResultsInSessionManager, Z as repairSessionFileIfNeeded, _ as createSystemPromptOverride, b as resolveEmbeddedAgentBaseStreamFn, c as ensureRuntimePluginsLoaded, ct as cleanupCompactionCheckpointSnapshot, d as flushPendingToolResultsAfterIdle, dt as persistSessionCompactionCheckpoint, et as createBundleLspToolRuntime, f as mapThinkingLevel, ft as resolveSessionCompactionCheckpointReason, g as buildEmbeddedSystemPrompt, h as applySystemPromptOverrideToSession, it as filterHeartbeatPairs, j as dropThinkingBlocks, k as limitHistoryTurns, l as buildEmbeddedCompactionRuntimeContext, m as collectAllowedToolNames, n as asCompactionHookRunner, nt as buildStreamErrorAssistantMessage, p as splitSdkTools, q as sessionLikelyHasOversizedToolResults, rt as resolveChannelCapabilities, s as runPostCompactionSideEffects, st as captureCompactionCheckpointSnapshot, t as readPiModelContextTokens, tt as releaseWsSession, u as resolveEmbeddedCompactionTarget, v as describeEmbeddedAgentStreamStrategy, w as trackSessionManagerAccess, x as resolveEmbeddedAgentStreamFn, y as resolveEmbeddedAgentApiKey } from "./model-context-tokens-BtPuWlQz.js";
import { i as enqueueCommandInLane } from "./command-queue-mO9kfkwk.js";
import { i as resolveContextWindowInfo, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-My1TcKCS.js";
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, f as normalizeEmbeddedAgentRuntime, i as extractToolResultMediaArtifact, l as sanitizeToolResult, m as resolveEmbeddedAgentRuntime, n as extractMessagingToolSend, o as filterToolResultMediaUrls, p as resolveEmbeddedAgentHarnessFallback, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-wcms1O8a.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-BwgrIC7s.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BPva_LgX.js";
import { t as getMachineDisplayName } from "./machine-name-DT3NeTWS.js";
import { f as MAX_IMAGE_BYTES } from "./mime-BY3E3Z_p.js";
import { n as buildTtsSystemPromptHint } from "./tts-Dz_UY2jH.js";
import { t as isReasoningTagProvider } from "./provider-utils-KZ1udzPx.js";
import { n as estimateBase64DecodedBytes } from "./base64-B7FGdSH9.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-BcggOJnr.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-ciaCG5Jv.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-BtMJRen2.js";
import { A as parseImageSizeError, D as isRateLimitAssistantError, E as isLikelyContextOverflowError, F as resolveBootstrapTotalMaxChars, N as resolveBootstrapMaxChars, P as resolveBootstrapPromptTruncationWarningMode, S as isCompactionFailureError, T as isFailoverErrorMessage, _ as extractObservedOverflowTokenCount, a as isMessagingToolDuplicateNormalized, b as isBillingAssistantError, c as extractToolCallsFromAssistant, d as downgradeOpenAIFunctionCallReasoningPairs, k as parseImageDimensionError, m as classifyFailoverReason, n as validateGeminiTurns, o as normalizeTextForComparison, r as pickFallbackThinkingLevel, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist, v as formatAssistantErrorText, w as isFailoverAssistantError, x as isCloudCodeAssistFormatError, y as isAuthAssistantError } from "./pi-embedded-helpers-x9Tf7Zu1.js";
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-CpocaYYo.js";
import { C as isTimeoutErrorMessage, D as parseExecApprovalResultText, d as stableStringify$1, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DVLttSO5.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BG8bgK9t.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-Qs2ls0OP.js";
import { a as isTimeoutError, n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Dvvg9Pjq.js";
import { a as shouldUseOpenAIWebSocketTransport, c as supportsModelTools, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as logProviderToolSchemaDiagnostics, r as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-C-LyLIvz.js";
import { t as log$3 } from "./logger-BPvqlpKv.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-C4bDf5Fw.js";
import { i as getOrCreateSessionMcpRuntime, n as materializeBundleMcpToolsForRun, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-CXkvr7pD.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DLP99vUx.js";
import { r as splitMediaFromOutput } from "./parse-BbMNIE4d.js";
import { x as parseReplyDirectives } from "./deliver-BfVgOanr.js";
import { r as resolveToolDisplay } from "./tool-display-D9yKN97M.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent, s as emitAgentPlanEvent } from "./agent-events-L3WabTAF.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-E45DGgMK.js";
import { A as buildApiErrorObservationFields, O as isStrictAgenticExecutionContractActive, a as buildActiveVideoGenerationTaskPromptContextForSession, d as LiveSessionModelSwitchError, f as shouldAllowCooldownProbeForReason, j as buildTextObservationFields, k as isStrictAgenticSupportedProviderModel, o as buildActiveMusicGenerationTaskPromptContextForSession } from "./openclaw-tools-gljDkcq_.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-BHQL9xAe.js";
...
import { n as applyPiAutoCompactionGuard } from "./pi-settings-B9ICih3I.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-BIbgLmrc.js";
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-Bgfqr3vS.js";
import { o as resolveGlobalLane, s as resolveSessionLane } from "./queue-DZ_zeJck.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-XuiAjTgG.js";
import { t as resolveAgentTimeoutMs } from "./timeout-oGay3Wrd.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CyOxx3eo.js";
import { a as isRedactedSessionsSpawnAttachment, i as resolveCacheRetention, l as sanitizeToolUseResultPairing, n as resolveAgentTransportOverride, r as isGooglePromptCacheEligible, t as applyExtraParamsToAgent } from "./extra-params-YA7NJcFo.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-C6trbPq0.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-C1n6Vs5p.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CSCRNEc4.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BWVQ1Iv3.js";
import { n as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CRA60wPE.js";
import { n as resolveRunWorkspaceDir, r as detectAndLoadPromptImages, t as redactRunIdentifier } from "./workspace-run-CmVflHl3.js";
import "./ollama-runtime-Dl_fhGAB.js";
...
*/
function redactImageDataForDiagnostics(value) {
...
const PLANNING_ONLY_PROMISE_RE = /\b(?:i(?:'ll| will)|let me|going to|first[, ]+i(?:'ll| will)|next[, ]+i(?:'ll| will)|i can do that)\b/i;
...
function resolvePlanningOnlyRetryInstruction(params) {
	...
	if (!shouldApplyPlanningOnlyRetryGuard({
		provider: params.provider,
		modelId: params.modelId
	}) || params.aborted || params.timedOut || params.attempt.clientToolCall || params.attempt.yieldDetected || params.attempt.didSendDeterministicApprovalPrompt || params.attempt.didSendViaMessagingTool || params.attempt.lastToolError || hasNonPlanToolActivity(params.attempt.toolMetas) || params.attempt.itemLifecycle.startedCount > planOnlyToolMetaCount || params.attempt.replayMetadata.hadPotentialSideEffects) return null;
	const stopReason = params.attempt.lastAssistant?.stopReason;
	if (stopReason && stopReason !== "stop") return null;
	const text = params.attempt.assistantTexts.join("\n\n").trim();
	if (!text || text.length > 700 || text.includes("```")) return null;
	if (!PLANNING_ONLY_PROMISE_RE.test(text) && !hasStructuredPlanningOnlyFormat(text)) return null;
...
function handleMessageUpdate(ctx, evt) {
	...
	const suppressDeterministicApprovalOutput = ctx.state.deterministicApprovalPromptPending || ctx.state.deterministicApprovalPromptSent;
	...
	if (chunk) {
		...
		if (!shouldUsePhaseAwareBlockReply) if (ctx.blockChunker) ctx.blockChunker.append(chunk);
	...
	if (next) {
		...
		if (shouldUsePhaseAwareBlockReply) {
			...
			if (blockReplyChunk) if (ctx.blockChunker) ctx.blockChunker.append(blockReplyChunk);
			else ctx.state.blockBuffer += blockReplyChunk;
			if (evtType === "text_end" && !ctx.state.lastBlockReplyText && cleanedText) if (ctx.blockChunker) {
				ctx.blockChunker.reset();
				ctx.blockChunker.append(cleanedText);
			} else ctx.state.blockBuffer = cleanedText;
		}
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-CHvKwW2Q.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-DcFPJHG8.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-CO1tAY9S.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-BDqhuG6o.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-DTZJNll7.js");
...
async function emitToolResultOutput(params) {
	...
	if (ctx.shouldEmitToolOutput() || shouldEmitCompactToolOutput({
		...
		if (outputText) {
			...
			if (ctx.params.toolResultFormat === "plain") emittedToolOutputMediaUrls = await collectEmittedToolOutputMediaUrls(toolName, outputText, result);
		}
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		try {
			...
			activeSession.agent.streamFn = wrapStreamFnTrimToolCallNames(activeSession.agent.streamFn, allowedToolNames);
			...
			try {
				...
				promptCache = buildContextEnginePromptCacheInfo({
					...
					observation: cacheObservabilityEnabled && (cacheBreak || promptCacheChangesForTurn || typeof attemptUsage?.cacheRead === "number") ? {
...
function createFailoverDecisionLogger(base) {
	...
	return (decision, extra) => {
		...
		log$3.warn("embedded run failover decision", {
			...
			status: extra?.status,
			...observedError,
			consoleMessage: `embedded run failover decision: runId=${safeRunId} stage=${normalizedBase.stage} decision=${decision} reason=${reasonText} provider=${safeProvider}/${safeModel} profile=${profileText}`
		});
	};
}
//#endregion
...
function resolveEffectiveRuntimeModel(params) {
	...
	if (ctxGuard.shouldWarn) log$3.warn(`low context window: ${params.provider}/${params.modelId} ctx=${ctxGuard.tokens} (warn<${CONTEXT_WINDOW_WARN_BELOW_TOKENS}) source=${ctxGuard.source}`);
	if (ctxGuard.shouldBlock) {
		log$3.error(`blocked model (context window too small): ${params.provider}/${params.modelId} ctx=${ctxGuard.tokens} (min=${CONTEXT_WINDOW_HARD_MIN_TOKENS}) source=${ctxGuard.source}`);
		...
		return enqueueGlobal(async () => {
			...
			try {
				...
				while (true) {
					...
					const promptAdditions = [ackExecutionFastPathInstruction, planningOnlyRetryInstruction].filter((value) => typeof value === "string" && value.trim().length > 0);
					...
					if (promptError && !aborted && promptErrorSource !== "compaction") {
						...
						if (promptFailoverDecision.action === "surface_error") logPromptFailoverDecision("surface_error");
						throw promptError;
					}
					...
					const assistantFailoverOutcome = await handleAssistantFailover({
						initialDecision: resolveRunFailoverDecision({
							stage: "assistant",
							aborted,
							externalAbort,
							fallbackConfigured,
					...
					if (assistantFailoverOutcome.action === "throw") throw assistantFailoverOutcome.error;
					const usageMeta = buildUsageAgentMetaFields({
						usageAccumulator,
					...
					if (!incompleteTurnText && nextPlanningOnlyRetryInstruction && planningOnlyRetryAttempts < maxPlanningOnlyRetryAttempts) {
					...
					return {
						...
						meta: {
							...
							replayInvalid,
							livenessState,
							stopReason: attempt.clientToolCall ? "tool_calls" : attempt.yieldDetected ? "end_turn" : sessionLastAssistant?.stopReason,
...
//#endregion
export { compactEmbeddedPiSession as a, isLikelyExecutionAckPrompt as c, resolvePreferredSessionKeyForSessionIdMatches as i, resolveSession as n, selectAgentHarness as o, resolveSessionKeyForRequest as r, prepareSessionManagerForRun as s, runEmbeddedPiAgent as t };
