...
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-D88wZd3F.js";
...
import { l as saveAuthProfileStore, u as updateAuthProfileStoreWithLock } from "./store-CJsXfApK.js";
import { n as listProfilesForProvider, t as dedupeProfileIds } from "./profiles-B5JpuCYg.js";
...
function shouldProbeWhamForFailure(provider, reason) {
	return normalizeProviderId(provider ?? "") === "openai-codex" && (reason === "rate_limit" || reason === "unknown");
}
...
//#endregion
export { clearExpiredCooldowns as a, markAuthProfileCooldown as c, resolveProfileUnusableUntilForDisplay as d, resolveProfilesUnavailableReason as f, resolveTokenExpiryState as h, clearAuthProfileCooldown as i, markAuthProfileFailure as l, evaluateStoredCredentialEligibility as m, resolveAuthProfileOrder as n, getSoonestCooldownExpiry as o, sanitizeForConsole as p, calculateAuthProfileCooldownMs as r, isProfileInCooldown as s, resolveAuthProfileEligibility as t, markAuthProfileUsed as u };
