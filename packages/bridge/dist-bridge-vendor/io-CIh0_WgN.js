...
import { o as resolveRequiredHomeDir } from "./home-dir-Dayr4z4q.js";
import { l as isRecord$1, m as resolveUserPath, x as isPlainObject } from "./utils-BpVTx0yp.js";
import { o as discoverOpenClawPlugins, r as normalizeChatChannelId, s as resolvePluginCacheInputs, t as CHANNEL_IDS } from "./ids-BhKtFNS_.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { t as isSafeExecutableValue } from "./exec-safety-7wP3A279.js";
import { i as coerceSecretRef } from "./types.secrets-D88wZd3F.js";
import { o as listBundledChannelPlugins, t as getBundledChannelPlugin } from "./bundled-CpwZ2fW5.js";
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { _ as resolveStateDir, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath } from "./paths-D9v5qmRt.js";
import { c as normalizeAgentId } from "./session-key-CprbVBQX.js";
import { t as isBlockedObjectKey } from "./prototype-keys-B9rjoUHr.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BMe6W-KZ.js";
import { h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-D2A6iYD-.js";
import { n as asNullableRecord } from "./record-coerce-zl3pijE0.js";
import { i as runPluginSetupConfigMigrations, s as getCachedPluginJitiLoader } from "./setup-registry-D8Eid6bm.js";
import { n as VERSION } from "./version-BajQ5RLp.js";
import { i as resolveManifestContractPluginIds, n as loadPluginManifestRegistry, r as resolveManifestContractOwnerPluginId } from "./manifest-registry--_2x2rrY.js";
import { r as hasKind } from "./slots-YfKufJfg.js";
import { a as resolveGatewayPortWithDefault, i as isGatewayNonLoopbackBindMode, r as hasConfiguredControlUiAllowedOrigins, t as buildDefaultControlUiAllowedOrigins } from "./gateway-control-ui-origins-DCRfSnSx.js";
import { r as normalizeProviderId } from "./provider-id-DDriY74A.js";
import { t as resolveSingleAccountKeysToMove } from "./setup-promotion-helpers-Dj9G68HP.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BuTtS5Gf.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-DLbn4RRx.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-Bko9o5XK.js";
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-B0Rck7M4.js";
import { t as loadDotEnv } from "./dotenv-Fe5s2rC8.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-b7QjLklz.js";
import { t as sanitizeTerminalText } from "./safe-text-CjhEHNvd.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-BM77yMra.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-CBd7vs8b.js";
import { i as applyMergePatch, n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-s2bic7WL.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-ClFoaYc7.js";
import { i as normalizeTrustedSafeBinDirs, z as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-B9XsS8AJ.js";
import { a as loadPinnedRuntimeConfig, i as getRuntimeConfigSourceSnapshot, n as finalizeRuntimeSnapshotWrite, o as notifyRuntimeConfigWriteListeners, r as getRuntimeConfigSnapshot, s as registerRuntimeConfigWriteListener } from "./runtime-snapshot-DWfOZ0HB.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CxcCP7jM.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-WJYsICp_.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, s as resolveEffectivePluginActivationState } from "./config-state-9vPQf81t.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-CVJo2Rgb.js";
import { n as loadBundledChannelSecurityContractApi } from "./channel-contract-api-Ccfuo4ei.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-Cx93k8M1.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-CqT8RkYB.js";
import { t as OpenClawSchema } from "./zod-schema-ddm1VQge.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-DEbKeYdJ.js";
...
function applyChannelDoctorCompatibilityMigrations(cfg) {
	const compat = applyPluginDoctorCompatibilityMigrations(cfg, { pluginIds: collectRelevantDoctorChannelIds(cfg) });
	return {
		next: compat.config,
...
function hasMappedLegacyWebSearchConfig(raw) {
	...
	return LEGACY_WEB_SEARCH_PROVIDER_IDS.some((providerId) => isRecord$1(search[providerId]));
}
...
function normalizeLegacyWebSearchConfigRecord(raw) {
	...
	for (const [key, value] of Object.entries(search)) {
		...
		if (LEGACY_WEB_SEARCH_PROVIDER_ID_SET.has(key) && isRecord$1(value)) continue;
...
function collectConfiguredChannelIds$1(cfg) {
...
async function runChannelDoctorConfigSequences(params) {
	const changeNotes = [];
	const warningNotes = [];
	for (const entry of listChannelDoctorEntries(collectConfiguredChannelIds$1(params.cfg))) {
...
function collectChannelDoctorCompatibilityMutations(cfg) {
	const channelIds = collectConfiguredChannelIds$1(cfg);
...
async function collectChannelDoctorStaleConfigMutations(cfg) {
	const mutations = [];
	let nextCfg = cfg;
	for (const entry of listChannelDoctorEntries(collectConfiguredChannelIds$1(cfg))) {
...
function resolveBundledProviderPolicySurface(providerId) {
	...
	if (bundledProviderPolicySurfaceCache.has(normalizedProviderId)) return bundledProviderPolicySurfaceCache.get(normalizedProviderId) ?? null;
...
function normalizeCompatibilityConfigValues(cfg) {
	...
	const setupMigration = runPluginSetupConfigMigrations({ config: next });
	...
	for (const mutation of collectChannelDoctorCompatibilityMutations(next)) {
		if (mutation.changes.length === 0) continue;
...
function applyRuntimeLegacyConfigMigrations(raw) {
	...
	const normalized = normalizeCompatibilityConfigValues(migrated.next ?? original);
...
function resolvePersistCandidateForWrite(params) {
	...
	return applyMergePatch(projectSourceOntoRuntimeShape(params.sourceConfig, params.runtimeConfig), patch);
}
...
function collectChannelLegacyConfigRules(raw) {
...
function collectUnsupportedSecretRefConfigCandidates(raw) {
	if (!isRecord$1(raw)) return [];
	const candidates = [];
	const commands = isRecord$1(raw.commands) ? raw.commands : null;
	if (commands) candidates.push({
		path: "commands.ownerDisplaySecret",
		value: commands.ownerDisplaySecret
	});
	const hooks = isRecord$1(raw.hooks) ? raw.hooks : null;
	if (hooks) {
		candidates.push({
			path: "hooks.token",
			value: hooks.token
		});
		const gmail = isRecord$1(hooks.gmail) ? hooks.gmail : null;
		...
		if (Array.isArray(mappings)) for (const [index, mapping] of mappings.entries()) {
			if (!isRecord$1(mapping)) continue;
			candidates.push({
	...
	if (isRecord$1(raw.channels)) for (const channelId of Object.keys(raw.channels)) {
		const channelCandidates = loadBundledChannelSecurityContractApi(channelId)?.collectUnsupportedSecretRefConfigCandidates?.(raw);
...
//#endregion
export { collectChannelDoctorStaleConfigMutations as $, unsetConfigOverride as A, normalizeCompatibilityConfigValues as B, collectPluginSchemaMetadata as C, getConfigOverrides as D, applyConfigOverrides as E, asResolvedSourceConfig as F, resolveActiveTalkProviderConfig as G, normalizeGoogleApiBaseUrl as H, asRuntimeConfig as I, resolveSubagentMaxConcurrent as J, resolveBundledProviderPolicySurface as K, findLegacyConfigIssues as L, parseConfigPath as M, setConfigValueAtPath as N, resetConfigOverrides as O, unsetConfigValueAtPath as P, collectChannelDoctorRepairMutations as Q, collectDurableServiceEnvVars as R, collectChannelSchemaMetadata as S, resolveShellEnvExpectedKeys as T, buildTalkConfigResponse as U, DEFAULT_GOOGLE_API_BASE_URL as V, normalizeTalkSection as W, collectChannelDoctorMutableAllowlistWarnings as X, collectChannelDoctorEmptyAllowlistExtraWarnings as Y, collectChannelDoctorPreviewWarnings as Z, collectUnsupportedSecretRefPolicyIssues as _, loadConfig as a, resolveOwnerDisplaySetting as at, validateConfigObjectRawWithPlugins as b, readBestEffortConfig as c, readSourceConfigSnapshot as d, runChannelDoctorConfigSequences as et, readSourceConfigSnapshotForWrite as f, normalizeOpenClawVersionBase as g, writeConfigFile as h, getRuntimeConfig as i, listPluginDoctorLegacyConfigRules as it, getConfigValueAtPath as j, setConfigOverride as k, readConfigFileSnapshot as l, resolveConfigSnapshotHash as m, clearConfigCache as n, applyLegacyDoctorMigrations as nt, parseConfigJson5 as o, registerConfigWriteListener as p, resolveAgentMaxConcurrent as q, createConfigIO as r, collectRelevantDoctorPluginIds as rt, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning as tt, readConfigFileSnapshotForWrite as u, validateConfigObject as v, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as w, validateConfigObjectWithPlugins as x, validateConfigObjectRaw as y, createConfigRuntimeEnv as z };
