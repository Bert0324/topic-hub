...
import { a as normalizeAnyChannelId, p as getActivePluginChannelRegistryFromState } from "./registry-BRjSWImW.js";
...
import { n as buildChannelAccountKey, r as normalizeConversationRef, t as normalizeConversationText } from "./conversation-id-D6QjvxNL.js";
import "./json-store-f9EelTXd.js";
...
function isBindingExpired(record, now = Date.now()) {
	return typeof record.expiresAt === "number" && Number.isFinite(record.expiresAt) ? record.expiresAt <= now : false;
}
...
const __testing = {
	resetSessionBindingAdaptersForTests() {
		...
		__testing$1.resetCurrentConversationBindingsForTests({ deletePersistedFile: true });
	},
...
//#endregion
export { registerSessionBindingAdapter as a, isSessionBindingError as i, __testing as n, unregisterSessionBindingAdapter as o, getSessionBindingService as r, SessionBindingError as t };
