...
import { _ as shortenHomePath } from "./utils-BpVTx0yp.js";
import { i as coerceSecretRef } from "./types.secrets-D88wZd3F.js";
import { t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { a as resolveAgentDir, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-DDriY74A.js";
import { n as resolveExecDefaults } from "./exec-defaults-BjFX32hR.js";
import { d as renderExecTargetLabel } from "./bash-tools.exec-runtime-DE7Rf9Fd.js";
...
import { g as resolveAuthStorePathForDisplay, n as ensureAuthProfileStore } from "./store-CJsXfApK.js";
import { r as resolveAuthProfileDisplayLabel } from "./auth-profiles-1eTJwiqc.js";
import { n as resolveAuthProfileOrder, s as isProfileInCooldown } from "./order-Co3gVz_f.js";
import { n as formatXHighModelHint } from "./thinking.shared-nRv_dCJ1.js";
import { T as modelKey, d as resolveConfiguredModelRef, m as resolveModelRefFromString } from "./model-selection-DYo_mceY.js";
...
import { n as resolveQueueSettings, s as refreshQueuedFollowupSession } from "./settings-runtime-CVvWjIXr.js";
...
import { n as applyVerboseOverride, t as applyTraceOverride } from "./level-overrides-C4TN54oS.js";
import { i as resolveModelsCommandReply } from "./commands-models-BUuxm64p.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-D0eeNnPq.js";
import { a as formatElevatedRuntimeHint, c as formatInternalVerboseCurrentReplyOnlyText, d as resolveModelSelectionFromDirective, i as formatDirectiveAck, l as formatInternalVerbosePersistenceDeniedText, n as canPersistInternalVerboseDirective, o as formatElevatedUnavailableText, r as enqueueModeSwitchEvents, s as formatInternalExecPersistenceDeniedText, t as canPersistInternalExecDirective, u as withOptions } from "./directive-handling.shared-BOiUy0qz.js";
import { r as formatRemainingShort } from "./auth-health-Crqhw6UG.js";
import { t as maskApiKey } from "./mask-api-key-CGqvijkC.js";
...
async function handleDirectiveOnly(params) {
	...
	if (directives.hasTraceDirective && !directives.traceLevel) {
		if (!directives.rawTraceLevel) return { text: withOptions(`Current trace level: ${sessionEntry.traceLevel ?? "off"}.`, "on, off") };
		return { text: `Unrecognized trace level "${directives.rawTraceLevel}". Valid levels: off, on.` };
	}
	if (directives.hasFastDirective && directives.fastMode === void 0) {
		if (!directives.rawFastMode || normalizeLowercaseStringOrEmpty(directives.rawFastMode) === "status") return { text: withOptions(`Current fast mode: ${effectiveFastMode ? "on" : "off"}${effectiveFastModeSource === "config" ? " (config)" : effectiveFastModeSource === "default" ? " (default)" : ""}.`, "status, on, off") };
		return { text: `Unrecognized fast mode "${directives.rawFastMode}". Valid levels: status, on, off.` };
	}
	...
	if (shouldPersistSessionEntry) {
		...
		if (modelSelection && modelSelectionUpdated && sessionKey) refreshQueuedFollowupSession({
			key: sessionKey,
	...
	if (directives.hasTraceDirective && directives.traceLevel) parts.push(directives.traceLevel === "off" ? formatDirectiveAck("Plugin trace disabled.") : formatDirectiveAck("Plugin trace enabled."));
