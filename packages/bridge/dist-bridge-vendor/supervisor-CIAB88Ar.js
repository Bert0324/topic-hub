...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-BP7rAGD2.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-B3YhQf60.js");
...
//#endregion
export { sanitizeBinaryOutput as i, detectRuntimeShell as n, getShellConfig as r, getProcessSupervisor as t };
