...
import { a as formatExecSecretRefIdValidationMessage, o as isValidExecSecretRefId, s as isValidFileSecretRefId } from "./ref-contract-aCgdDCZE.js";
import { t as sensitive } from "./zod-schema.sensitive-QBR_HB-s.js";
...
const ConfiguredProviderRequestTlsSchema = z.object({
...
const ConfiguredProviderRequestAuthSchema = z.union([
...
const ConfiguredProviderRequestProxySchema = z.union([z.object({
...
const ConfiguredProviderRequestSchema = z.object(ConfiguredProviderRequestFields).strict().optional();
const ConfiguredModelProviderRequestSchema = z.object({
...
const ContextVisibilityModeSchema = z.enum([
	"all",
	"allowlist",
	"allowlist_quote"
]);
...
const TtsProviderConfigSchema = z.object({ apiKey: SecretInputSchema.optional().register(sensitive) }).catchall(z.union([
	z.string(),
	z.number(),
	z.boolean(),
	z.null(),
...
const ToolsMediaSchema = z.object({
	...
	asyncCompletion: z.object({ directSend: z.boolean().optional() }).strict().optional(),
...
//#endregion
export { TtsAutoSchema as A, SecretInputSchema as C, ToolsLinksSchema as D, SecretsConfigSchema as E, requireAllowlistAllowFrom as F, requireOpenAllowFrom as I, createAllowDenyChannelRulesSchema as L, TtsModeSchema as M, TtsProviderSchema as N, ToolsMediaSchema as O, TypingModeSchema as P, MODEL_APIS as R, RetryConfigSchema as S, SecretRefSchema as T, NativeCommandsSettingSchema as _, DmConfigSchema as a, ReplyRuntimeConfigSchemaShape as b, GroupChatSchema as c, HumanDelaySchema as d, IdentitySchema as f, ModelsConfigSchema as g, MarkdownConfigSchema as h, ContextVisibilityModeSchema as i, TtsConfigSchema as j, TranscribeAudioSchema as k, GroupPolicySchema as l, MSTeamsReplyStyleSchema as m, BlockStreamingCoalesceSchema as n, DmPolicySchema as o, InboundDebounceSchema as p, CliBackendSchema as r, ExecutableTokenSchema as s, BlockStreamingChunkSchema as t, HexColorSchema as u, ProviderCommandsSchema as v, SecretProviderSchema as w, ReplyToModeSchema as x, QueueSchema as y };
