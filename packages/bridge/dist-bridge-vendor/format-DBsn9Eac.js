...
import { r as formatDurationPrecise } from "./format-duration-DIThMZKk.js";
...
import { a as formatGitInstallLabel, g as resolveUpdateChannelDisplay, m as normalizeUpdateChannel } from "./update-check-BgAmIjvk.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner } from "./status.update-_T42VgKz.js";
...
function formatStatusTailscaleValue(params) {
	...
	if (params.tailscaleMode === "off") {
		const suffix = [params.includeBackendStateWhenOff && params.backendState ? params.backendState : null, params.includeDnsNameWhenOff && params.dnsName ? params.dnsName : null].filter(Boolean).join(" · ");
