...
import { n as resolveBundledPluginPublicSurfacePath, t as normalizeBundledPluginArtifactSubpath } from "./public-surface-runtime-DGyu-4Em.js";
import { a as loadFacadeModuleAtLocationSync$1, i as loadBundledPluginPublicSurfaceModuleSync$1 } from "./facade-loader-BLNwa1s-.js";
...
let facadeActivationCheckRuntimeJiti;
function getFacadeActivationCheckRuntimeJiti() {
	if (facadeActivationCheckRuntimeJiti) return facadeActivationCheckRuntimeJiti;
...
function loadFacadeActivationCheckRuntime() {
	...
	for (const candidate of FACADE_ACTIVATION_CHECK_RUNTIME_CANDIDATES) try {
		facadeActivationCheckRuntimeModule = nodeRequire(candidate);
		return facadeActivationCheckRuntimeModule;
	} catch {}
	const jiti = getFacadeActivationCheckRuntimeJiti();
	for (const candidate of FACADE_ACTIVATION_CHECK_RUNTIME_CANDIDATES) try {
		facadeActivationCheckRuntimeModule = jiti(candidate);
		return facadeActivationCheckRuntimeModule;
	} catch {}
...
//#endregion
export { tryLoadActivatedBundledPluginPublicSurfaceModuleSync as n, loadActivatedBundledPluginPublicSurfaceModuleSync as t };
