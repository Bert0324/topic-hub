...
import { c as escapeRegExp } from "./utils-BpVTx0yp.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { t as formatDurationCompact } from "./format-duration-DIThMZKk.js";
import { b as isSubagentSessionKey, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey, y as isCronSessionKey } from "./session-key-CprbVBQX.js";
import { a as logWarn, r as logInfo } from "./logger-tSqm_V4O.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DekfzodU.js";
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-B0Rck7M4.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-b7QjLklz.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-B9XsS8AJ.js";
import { t as splitShellArgs } from "./shell-argv-VK8Cl5EF.js";
import { B as describeInterpreterInlineEval, C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, G as buildEnforcedShellCommand, P as evaluateShellAllowlist, V as detectInterpreterInlineEvalArgv, W as analyzeShellCommand, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-BsyvYleM.js";
import { A as listFinishedSessions, C as resolveWorkdir, D as drainSession, E as deleteSession, F as tail, I as applyPathPrepend, L as normalizePathPrepend, M as markBackgrounded, N as markExited, O as getFinishedSession, P as setJobTtlMs, S as resolveSandboxWorkdir, T as truncateMiddle, _ as clampWithDefault, a as DEFAULT_PENDING_MAX_OUTPUT, b as pad, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as buildSandboxEnv, i as DEFAULT_PATH, j as listRunningSessions, k as getSession, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as coerceEnv, w as sliceLogLines, x as readEnvInt, y as deriveSessionName } from "./bash-tools.exec-runtime-DE7Rf9Fd.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-DQgMr1Hj.js";
import { a as isGatewayMessageChannel, d as normalizeMessageChannel } from "./message-channel-BsZYykgY.js";
import { t as getProcessSupervisor } from "./supervisor-CIAB88Ar.js";
import { t as killProcessTree } from "./kill-tree-DShMKvsc.js";
import "./delivery-context-DfqDfkC4.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DGRh7BNn.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-MOi9vR7_.js";
import { D as parseExecApprovalResultText, E as isExecDeniedResultText, T as formatExecDeniedUserMessage, u as sanitizeUserFacingText } from "./sanitize-user-facing-text-DVLttSO5.js";
import { _ as textResult, a as failedTextResult } from "./common-CqmjNIs4.js";
import { t as callGatewayTool } from "./gateway-BeBZlMTt.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DRUiV8Pk.js";
import { t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-Co_6GYrb.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-JbXMH9i6.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DHFaZf7J.js";
...
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-pE74J4oY.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-XneTGtTY.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-BVJCFMWa.js";
...
createProcessTool();
//#endregion
export { createExecTool as n, createProcessTool as t };
