...
import { c as MANIFEST_KEY } from "./manifest-DVVfeFh-.js";
import { r as listChannelPlugins } from "./registry-BkswxGUu.js";
import { h as resolveOAuthDir } from "./paths-D9v5qmRt.js";
import { c as normalizeAgentId } from "./session-key-CprbVBQX.js";
import { h as resolveDefaultAgentId } from "./agent-scope-D2A6iYD-.js";
import { f as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-Hf0tgqHz.js";
import { u as resolveToolProfilePolicy } from "./tool-policy-DekfzodU.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-BsZgPBUU.js";
import { a as normalizePluginsConfig } from "./config-state-9vPQf81t.js";
import { r as resolveSkillSource } from "./sanitize-env-vars-ICggrYzp.js";
...
import { a as execDockerRaw } from "./docker-BiB27J1v.js";
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-3XeKxF5X.js";
import { r as pickSandboxToolPolicy, t as isToolAllowedByPolicies } from "./tool-policy-match-KGmAd_zv.js";
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-B3tGtI0h.js";
import { r as resolveNativeSkillsEnabled } from "./commands-pSxqdDkB.js";
import { n as readInstalledPackageVersion } from "./package-update-utils-C-S51O88.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DqZFRJf9.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-DWbuLO75.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-B_Urpjkp.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-TGRrALN_.js");
...
async function collectSandboxBrowserHashLabelFindings(params) {
	...
	for (const containerName of containers) {
		...
		if (labels.epoch !== "2026-04-05-cdp-source-range") staleEpoch.push(containerName);
...
async function collectPluginsTrustFindings(params) {
	...
	if (pluginDirs.length > 0) {
		...
		if (!(Array.isArray(allow) && allow.length > 0)) {
			const skillCommandsLikelyExposed = (await Promise.all(listChannelPlugins().map(async (plugin) => {
