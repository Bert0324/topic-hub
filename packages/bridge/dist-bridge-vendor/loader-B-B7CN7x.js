import { i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString, u as normalizeStringifiedOptionalString } from "./string-coerce-D8LAEut5.js";
import { l as normalizeTrimmedStringList } from "./string-normalization-DO5qgVap.js";
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-4GSqtybS.js";
import { l as isRecord, m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { _ as mergeBundlePathLists, d as safeStatSync, f as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, l as isPathInside, m as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH, o as discoverOpenClawPlugins, p as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH, s as resolvePluginCacheInputs, v as normalizeBundlePathList } from "./ids-BhKtFNS_.js";
import { t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { f as resolvePluginRuntimeModulePath, g as shouldPreferNativeJiti, n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-DQeTRBMb.js";
import { p as unwrapDefaultModuleExport } from "./bundled-CpwZ2fW5.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry--_2x2rrY.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-YfKufJfg.js";
import { t as buildPluginApi } from "./api-builder-zbMVLSTT.js";
import { i as applyMergePatch, t as validateJsonSchemaValue } from "./schema-validator-s2bic7WL.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, n as createPluginActivationSource, o as resolveEffectiveEnableState, s as resolveEffectivePluginActivationState, t as applyTestPluginDefaults } from "./config-state-9vPQf81t.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND } from "./node-commands-Dq3gO7An.js";
import { n as resolveGlobalSingleton } from "./global-singleton-Bu7EzZLX.js";
import { a as normalizePluginIdScope, n as createPluginIdScopeSet, o as serializePluginIdScope, r as hasExplicitPluginIdScope, t as isChannelConfigured } from "./channel-configured-jSiWbzTw.js";
import { I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-BY8xbNeY.js";
import { a as clearPluginCommands, i as validatePluginCommandDefinition, n as registerPluginCommand } from "./command-registration-iyF8S6qf.js";
import { i as initializeGlobalHookRunner } from "./hook-runner-global-CWxC3y8-.js";
import { a as isPromptInjectionHookName, c as clearPluginInteractiveHandlers, i as isPluginHookName, s as stripPromptMutationFieldsFromLegacyHookResult, u as registerPluginInteractiveHandler } from "./types-DJOITndb.js";
import { a as getMemoryPromptSectionBuilder, d as registerMemoryCapability, f as registerMemoryCorpusSupplement, g as registerMemoryRuntime, h as registerMemoryPromptSupplement, i as getMemoryFlushPlanResolver, l as listMemoryCorpusSupplements, m as registerMemoryPromptSection, n as clearMemoryPluginState, o as getMemoryRuntime, p as registerMemoryFlushPlanResolver, r as getMemoryCapabilityRegistration, u as listMemoryPromptSupplements, v as restoreMemoryPluginState } from "./memory-state-jIh7Lh-v.js";
import { n as registerContextEngineForOwner } from "./registry-CSroj6Lo.js";
import { f as registerInternalHook, h as unregisterInternalHook } from "./internal-hooks-0tvOr1P0.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-DimJ77ap.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-B-vyuIuj.js";
import { b as createEmptyPluginRegistry, d as recordImportedPluginId, i as getActivePluginRegistryKey, r as getActivePluginRegistry, s as getActivePluginRuntimeSubagentMode, y as setActivePluginRegistry } from "./runtime-DcBif8u5.js";
import { r as withPluginRuntimePluginIdScope } from "./gateway-request-scope-BGqMEM1a.js";
...
function createPluginRegistry(registryParams) {
	...
	const registerChannel = (record, registration, mode = "full") => {
		...
		const id = normalizeOptionalString(plugin?.id) ?? normalizeStringifiedOptionalString(plugin?.id) ?? "";
		if (!id) {
			pushDiagnostic({
				level: "error",
				pluginId: record.id,
...
//#endregion
export { disposeRegisteredAgentHarnesses as _, resolveRuntimePluginRegistry as a, listRegisteredMemoryEmbeddingProviders as c, extractMcpServerMap as d, inspectBundleMcpRuntimeSupport as f, readBundleJsonObject as g, loadEnabledBundleConfig as h, resolveCompatibleRuntimePluginRegistry as i, registerMemoryEmbeddingProvider as l, inspectBundleServerRuntimeSupport as m, loadOpenClawPluginCliRegistry as n, getRegisteredMemoryEmbeddingProvider as o, loadEnabledBundleMcpConfig as p, loadOpenClawPlugins as r, listMemoryEmbeddingProviders as s, isPluginRegistryLoadInFlight as t, getCompactionProvider as u, listRegisteredAgentHarnesses as v, resetRegisteredAgentHarnessSessions as y };
