...
import { r as stripAnsi, t as sanitizeForLog } from "./ansi-Dm9DlII5.js";
import { t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { n as resolveAgentModelPrimaryValue, r as toAgentModelListLike, t as resolveAgentModelFallbackValues } from "./model-input-CZL2P3ko.js";
import { d as resolveAgentModelFallbacksOverride, i as resolveAgentConfig, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-D2A6iYD-.js";
...
import { t as listSetupCliBackendIds } from "./setup-descriptors-CP54ZQpr.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BuTtS5Gf.js";
import { p as resolveThinkingDefaultForModel } from "./thinking.shared-nRv_dCJ1.js";
import { n as normalizeStaticProviderModelId, t as modelKey$1 } from "./model-ref-shared-BlxceMSS.js";
...
function resolveThinkingDefault(params) {
	...
	const catalogCandidate = params.catalog?.find((entry) => entry.provider === params.provider && entry.id === params.model);
	const configuredModels = params.cfg.agents?.defaults?.models;
...
//#endregion
export { resolveRuntimeCliBackends as C, parseModelRef as D, normalizeModelRef as E, splitTrailingAuthProfile as O, isCliProvider as S, modelKey as T, resolvePersistedSelectedModelRef as _, getModelRefStatus as a, resolveSubagentSpawnModelSelection as b, normalizeStoredOverrideModel as c, resolveConfiguredModelRef as d, resolveDefaultModelForAgent as f, resolvePersistedOverrideModelRef as g, resolvePersistedModelRef as h, buildModelAliasIndex as i, resolveConfiguredProviderFallback as k, resolveAllowedModelRef as l, resolveModelRefFromString as m, buildConfiguredAllowlistKeys as n, inferUniqueProviderFromConfiguredModels as o, resolveHooksGmailModel as p, buildConfiguredModelCatalog as r, normalizeModelSelection as s, buildAllowedModelSet as t, resolveAllowlistModelKey as u, resolveReasoningDefault as v, legacyModelKey as w, resolveThinkingDefault as x, resolveSubagentConfiguredModelSelection as y };
