...
import { c as normalizeAgentId, o as classifySessionKeyShape, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
...
import { c as resolveSandboxedBridgeMediaPath, s as createSandboxBridgeReadFile } from "./openclaw-tools-gljDkcq_.js";
import { c as resolveMediaBufferPath, s as getMediaDir } from "./store-BqmRfmaG.js";
import { t as loadWebMedia } from "./web-media-Wpl2WQZ0.js";
import { n as sanitizeForPromptLiteral } from "./system-prompt-D83XxDVi.js";
...
async function loadImageFromRef(ref, workspaceDir, options) {
	if (ref.type === "media-uri") {
		...
		try {
			...
			log.debug(`Native image: failed to load media-uri ${ref.resolved}: ${formatErrorMessage(err)}`);
			return null;
		}
	}
	try {
...
//#endregion
export { loadImageFromRef as a, detectImageReferences as i, resolveRunWorkspaceDir as n, detectAndLoadPromptImages as r, redactRunIdentifier as t };
