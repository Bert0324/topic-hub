...
import { a as hasConfiguredSecretInput } from "./types.secrets-D88wZd3F.js";
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-D9v5qmRt.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-B9XsS8AJ.js";
import { H as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-BsyvYleM.js";
...
import { i as hasNonEmptyString } from "./channel-target-D3d-fzsn.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-3XeKxF5X.js";
import { o as resolveGatewayAuth } from "./auth-BpMEnTJc.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DRUiV8Pk.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BzHMgn11.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-rszYSBn-.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-B7Ri8vws.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DFm0zRit.js");
	return await auditChannelModulePromise;
}
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-BbUTA_TB.js");
	return await pluginRegistryLoaderModulePromise;
}
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-BV749vvY.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DlQ8xI7I.js"),
		import("./probe-auth-DOS1GvBr.js"),
		import("./probe-BMYJXogA.js")
