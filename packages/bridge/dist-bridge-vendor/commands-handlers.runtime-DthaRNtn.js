...
import { m as resolveUserPath, r as clampInt } from "./utils-BpVTx0yp.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { t as isApprovalNotFoundError } from "./approval-errors-BkcfKW3_.js";
import { r as logVerbose } from "./globals-DiVqdPR8.js";
import { t as formatDurationCompact } from "./format-duration-DIThMZKk.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CprbVBQX.js";
import { r as normalizeOptionalAccountId } from "./account-id-BMe6W-KZ.js";
import { a as resolveAgentDir, m as resolveAgentWorkspaceDir, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { A as unsetConfigOverride, D as getConfigOverrides, M as parseConfigPath, N as setConfigValueAtPath, O as resetConfigOverrides, P as unsetConfigValueAtPath, h as writeConfigFile, j as getConfigValueAtPath, k as setConfigOverride, l as readConfigFileSnapshot, x as validateConfigObjectWithPlugins } from "./io-CIh0_WgN.js";
import { t as clearPluginManifestRegistryCache } from "./manifest-registry--_2x2rrY.js";
import { t as parseDurationMs } from "./parse-duration-DOBbb8_k.js";
import "./config-_X90biGc.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-DE7Rf9Fd.js";
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-BsZYykgY.js";
import { n as resolveChannelApprovalCapability } from "./plugins-C60yWwZy.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DToSJrgK.js";
import "./sandbox-BJfRPwam.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-t6LWRwoW.js";
import "./diagnostic-DJUswuFo.js";
import { C as prepareProviderRuntimeAuth } from "./provider-runtime-ljZXzW8q.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-0tvOr1P0.js";
import { f as resolveResponseUsageMode, o as normalizeFastMode, u as normalizeUsageDisplay } from "./thinking.shared-nRv_dCJ1.js";
...
import { r as resolveModelWithRegistry } from "./model-DLtFzYCE.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-CDyGaBO4.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DHhnmVjI.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-Cd2GKMjD.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DPnQAudX.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-Dz_UY2jH.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BcggOJnr.js";
import { F as resolveBootstrapTotalMaxChars, N as resolveBootstrapMaxChars } from "./pi-embedded-helpers-x9Tf7Zu1.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-BG8bgK9t.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-C4bDf5Fw.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Bp7h7VWx.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-E45DGgMK.js";
import { r as callGateway } from "./call-e1uIKGwS.js";
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-7XyXWA28.js";
import { i as resolveReplyToMode } from "./reply-threading-M0fJAPUh.js";
import { b as formatConfigWriteDeniedMessageShared, v as authorizeConfigWriteShared, x as resolveConfigWriteTargetFromPathShared, y as canBypassConfigWritePolicyShared } from "./channel-config-helpers-B6pulziY.js";
...
import { r as getSessionBindingService } from "./session-binding-service-BIUfTe38.js";
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-XuiAjTgG.js";
import { u as stripToolResultDetails } from "./extra-params-YA7NJcFo.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CSCRNEc4.js";
import { n as estimateTokensFromChars } from "./cjk-chars-DzY8giRK.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-ZkHKgS2c.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-C-NVQWds.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-B6RK1JTl.js";
import "./commands-registry-Cpq8HdKx.js";
import { n as formatTimeAgo } from "./format-relative-fdP81CUk.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-Cb-cUToG.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DCglJ95k.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-Bb-XVaPT.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-IeUk5CX4.js";
import { l as resolveArchiveKind } from "./archive-DJpOQiz2.js";
import { n as parseActivationCommand } from "./group-activation-Bs8erurP.js";
import { t as resolveFastModeState } from "./fast-mode-BUmOqufM.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-B7z7-HUQ.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DDvYHrpY.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-GEP3wtyT.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-D3ht_CnS.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-BRrSHblQ.js";
import { t as extractBtwQuestion } from "./btw-command-D5CmHN81.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BOTTpwlk.js";
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-C_tXS2Zv.js";
import { t as handleAcpCommand } from "./commands-acp-BFn6CFCw.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-COlfTk9o.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BgYWO4iL.js";
import { r as handleModelsCommand } from "./commands-models-BUuxm64p.js";
import { n as setPluginEnabledInConfig } from "./enable-CawLDRmd.js";
import { n as createExecTool } from "./bash-tools-DqkcKf7x.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CNmxVA3i.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-DsJsvYyh.js";
import { t as buildToolsMessage } from "./status-DhDKEb6H.js";
import { t as parseConfigValue } from "./config-value-BFVjEXkF.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DOlaoj9r.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CNiK3qfB.js";
import { i as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus, t as buildStatusReply } from "./commands-status-Ba-C1JmC.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-C7ruskY2.js";
import { m as parseClawHubPluginSpec } from "./clawhub-BBJnfrmv.js";
import { r as installPluginFromClawHub } from "./clawhub-Ct9etILO.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-dkQfSqE5.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-CQEVPUAy.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BoyXfQsW.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-Cy1EOwnJ.js");
		killProcessTree(pid);
...
async function runBtwSideQuestion(params) {
	...
	const stream = await streamWithPayloadPatch(streamSimple, runtimeModel, {
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-WydmtA_R.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CsdhOANK.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-DoUAXVHG.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-CK3XW4Dl.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-CX_zvczz.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-CeOpPk-m.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-WJuCYuZG.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-D-7TBB8e.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-prF2UDNH.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-B6tlHpUF.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-Cpk2mN02.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-upUTXNDZ.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-B4E-eJlg.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-NZeS5AJA.js");
