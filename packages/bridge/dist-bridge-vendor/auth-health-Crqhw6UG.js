...
import { h as resolveTokenExpiryState, m as evaluateStoredCredentialEligibility } from "./order-Co3gVz_f.js";
...
function buildProfileHealth(params) {
	...
	return {
		...
		provider,
		type: "oauth",
		status: hasRefreshToken && (rawStatus === "expired" || rawStatus === "expiring") ? "ok" : rawStatus,
