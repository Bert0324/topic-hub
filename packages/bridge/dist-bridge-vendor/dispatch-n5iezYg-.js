...
import { v as sleep } from "./utils-BpVTx0yp.js";
...
import { r as generateSecureInt } from "./secure-random-BOfPlKTq.js";
import { x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { i as resolveAgentConfig, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
...
import { i as logMessageQueued, o as logSessionStateChange, r as logMessageProcessed } from "./diagnostic-DJUswuFo.js";
import { n as getGlobalPluginRegistry, t as getGlobalHookRunner } from "./hook-runner-global-CWxC3y8-.js";
...
import { d as normalizeVerboseLevel } from "./thinking.shared-nRv_dCJ1.js";
import { n as normalizeTtsAutoMode } from "./tts-auto-mode-B669b-p6.js";
import { u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { a as resolveSessionStoreEntry } from "./store-CZFUytbr.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-DiDjFCRt.js";
import { t as getReplyPayloadMetadata } from "./reply-payload-DLP99vUx.js";
import { c as toPluginInboundClaimEvent, f as fireAndForgetHook, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, s as toPluginInboundClaimContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-CpVrS909.js";
import { t as normalizeReplyPayload } from "./normalize-reply-DDeXBK6_.js";
import { a as buildPluginBindingUnavailableText, b as touchConversationBindingRecord, c as hasShownPluginBindingFallbackNotice, d as markPluginBindingFallbackNoticeShown, h as toPluginConversationBinding, n as buildPluginBindingDeclinedText, r as buildPluginBindingErrorText, u as isPluginOwnedSessionBindingRecord, y as resolveConversationBindingRecord } from "./conversation-binding-C45rTt9J.js";
import { n as resolveSendPolicy } from "./send-policy-Cw3tU_7b.js";
import { n as shouldAttemptTtsPayload, t as resolveConfiguredTtsMode } from "./tts-config-Bzd0OfWn.js";
...
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-BrWbrH90.js");
	return routeReplyRuntimePromise;
}
function loadGetReplyFromConfigRuntime() {
	getReplyFromConfigRuntimePromise ??= import("./get-reply-from-config.runtime-CQyR-DYU.js");
	return getReplyFromConfigRuntimePromise;
}
function loadAbortRuntime() {
	abortRuntimePromise ??= import("./abort.runtime-Dw62-Uw7.js");
	return abortRuntimePromise;
}
function loadTtsRuntime() {
	ttsRuntimePromise ??= import("./tts.runtime-DYA6kHT1.js");
...
async function dispatchReplyFromConfig(params) {
	...
	const sessionAgentCfg = resolveAgentConfig(cfg, resolveSessionAgentId({
	...
	*/
	...
	try {
		...
		const sendPlanUpdate = async (payload) => {
			if (!shouldEmitVerboseProgress()) return;
		...
		const replyResult = await (params.replyResolver ?? (await loadGetReplyFromConfigRuntime()).getReplyFromConfig)(ctx, {
			...
			onToolResult: (payload) => {
				const run = async () => {
					const deliveryPayload = resolveToolDeliveryPayload(await maybeApplyTtsToReplyPayload({
						payload,
						cfg,
						channel: ttsChannel,
						kind: "tool",
