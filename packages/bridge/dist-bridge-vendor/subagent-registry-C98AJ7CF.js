import { i as normalizeLowercaseStringOrEmpty, l as normalizeOptionalThreadValue, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
import { c as readErrorName, i as formatErrorMessage } from "./errors-BTh8VBsl.js";
...
import { l as normalizeMainKey, u as resolveAgentIdFromSessionKey, y as isCronSessionKey } from "./session-key-CprbVBQX.js";
import { n as normalizeAccountId } from "./account-id-BMe6W-KZ.js";
import { i as runExec } from "./exec-BP7rAGD2.js";
...
import { i as normalizeDeliveryContext$1, n as deliveryContextKey, r as mergeDeliveryContext$1 } from "./delivery-context.shared-DQgMr1Hj.js";
import { a as isGatewayMessageChannel, d as normalizeMessageChannel, o as isInternalMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BsZYykgY.js";
import { n as resolveConversationDeliveryTarget } from "./delivery-context-DfqDfkC4.js";
...
import { n as sanitizeTextContent, t as extractAssistantText } from "./chat-history-text-PVIH3zCk.js";
import { t as getSubagentDepthFromSessionStore } from "./subagent-depth-BWKrGM9q.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, r as completeTaskRunByRunId } from "./task-executor-DTBvc_JV.js";
import "./queue-DZ_zeJck.js";
import { c as applyQueueDropPolicy, d as buildCollectPrompt, f as clearQueueSummaryState, g as previewQueueSummaryPrompt, h as hasCrossChannelItems, l as applyQueueRuntimeSettings, m as drainNextQueueItem, p as drainCollectQueueStep, t as resolveQueueSettings, u as beginQueueDrain, v as waitForQueueDebounce } from "./settings-runtime-CVvWjIXr.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-Ctggyt-w.js";
import { r as normalizeConversationRef } from "./conversation-id-D6QjvxNL.js";
...
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, s as queueEmbeddedPiMessage } from "./runs-XuiAjTgG.js";
import { t as importRuntimeModule } from "./runtime-import-B76vLM38.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-BG1Bt-6s.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-DE7rARQv.js";
...
function loadSubagentRegistryRuntime() {
	subagentRegistryRuntimePromise ??= import("./subagent-announce.registry.runtime-COY7oT3L.js");
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (!childCompletionFindings) {
			...
			if (isAnnounceSkip(reply) || isSilentReplyText(reply, "NO_REPLY")) if (fallbackReply && !fallbackIsSilent) reply = fallbackReply;
			else return true;
		}
		if (!outcome) outcome = { status: "unknown" };
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-aDaDXIsI.js").then(({ scheduleOrphanRecovery }) => {
...
const { completeCleanupBookkeeping, completeSubagentRun, finalizeResumedAnnounceGiveUp, refreshFrozenResultFromSession, startSubagentAnnounceCleanupFlow } = createSubagentRegistryLifecycleController({
	runs: subagentRuns,
	resumedRuns,
...
function resumeSubagentRun(runId) {
	...
	subagentRunManager.waitForSubagentCompletion(runId, waitTimeoutMs);
	resumedRuns.add(runId);
}
...
//#endregion
export { isAnnounceSkip as C, resolveNestedAgentLane as D, AGENT_LANE_SUBAGENT as E, deliverSubagentAnnouncement as O, REPLY_SKIP_TOKEN as S, AGENT_LANE_NESTED as T, cleanupBrowserSessionsForLifecycleEnd as _, getLatestSubagentRunByChildSessionKey as a, runAgentStep as b, listSubagentRunsForController as c, registerSubagentRun as d, replaceSubagentRunAfterSteer as f, buildSubagentSystemPrompt as g, onSessionLifecycleEvent as h, countPendingDescendantRuns as i, formatAgentInternalEventsForPrompt as k, markSubagentRunForSteerRestart as l, emitSessionLifecycleEvent as m, countActiveDescendantRuns as n, initSubagentRegistry as o, scheduleSubagentOrphanRecovery as p, countActiveRunsForSession as r, listDescendantRunsForRequester as s, clearSubagentRunSteerRestart as t, markSubagentRunTerminated as u, closeTrackedBrowserTabsForSessions as v, isReplySkip as w, ANNOUNCE_SKIP_TOKEN as x, movePathToTrash as y };
