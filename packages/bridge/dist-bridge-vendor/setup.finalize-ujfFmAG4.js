import { d as pathExists, m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { t as restoreTerminalState } from "./restore-BBv6uosS.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-LfA0pl0B.js";
import { n as resolveCliName } from "./cli-name-B1COg_Jj.js";
import { t as formatCliCommand } from "./command-format-DDWL27WN.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-Cv0WpbgE.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B4If99Mx.js";
import { t as resolveControlUiLinks } from "./control-ui-links-D6yOulU2.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-BZUeKHbv.js";
import { h as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-NJz6ffph.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-Bfhnf1g0.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DUWNCPxP.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-qjg_Huy6.js";
import { r as installCompletion } from "./completion-runtime-C7dcjTrJ.js";
import { r as healthCommand } from "./health-DvxDMZmg.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DWcn0R1A.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-BKOfJgpO.js";
import { t as formatHealthCheckFailure } from "./health-format-DriInrWJ.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-mL_QYTSD.js";
import { t as runTui } from "./tui-Y5mSzEpU.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BYnmJ-8_.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-6DO46owM.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BDD4mPuF.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BDD4mPuF.js");
