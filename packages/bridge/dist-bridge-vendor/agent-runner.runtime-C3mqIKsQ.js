import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString, t as hasNonEmptyString } from "./string-coerce-D8LAEut5.js";
import { f as resolveConfigDir } from "./utils-BpVTx0yp.js";
...
import { a as generateSecureUuid } from "./secure-random-BOfPlKTq.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CprbVBQX.js";
import { v as resolveRunModelFallbacksOverride, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { n as resolveSandboxConfigForAgent } from "./config-Hf0tgqHz.js";
import { a as loadConfig } from "./io-CIh0_WgN.js";
import "./defaults-BuTtS5Gf.js";
import "./config-_X90biGc.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-BpWrwuiS.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BsZYykgY.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BJfRPwam.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-Cpd6ZLxF.js";
import { _ as resolveMemoryFlushPlan } from "./memory-state-jIh7Lh-v.js";
import { d as normalizeVerboseLevel, f as resolveResponseUsageMode } from "./thinking.shared-nRv_dCJ1.js";
import { S as isCliProvider } from "./model-selection-DYo_mceY.js";
import { c as resolveModelAuthMode } from "./model-auth--xFDcZHC.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-CDyGaBO4.js";
import { c as isLikelyExecutionAckPrompt, t as runEmbeddedPiAgent } from "./pi-embedded-runner-CXwB_I4U.js";
import { S as resolveGroupSessionKey, c as updateSessionStore, l as updateSessionStoreEntry } from "./store-CZFUytbr.js";
import "./sessions-axRgTD70.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-6DEWydwn.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { a as resolveContextTokensForModel } from "./context-BLKsjObp.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-Cd2GKMjD.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-BvqqZK_b.js";
import { i as readSessionMessages } from "./session-utils.fs-BqNJ-U8P.js";
import { I as readPostCompactionContext, N as estimateMessagesTokens } from "./model-context-tokens-BtPuWlQz.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-mO9kfkwk.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BwgrIC7s.js";
import { s as stripHeartbeatToken } from "./heartbeat-DhJX9hg6.js";
import { a as isAudioFileName } from "./mime-BY3E3Z_p.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BcggOJnr.js";
import { C as isContextOverflowError, E as isLikelyContextOverflowError, O as isTransientHttpError, S as isCompactionFailureError } from "./pi-embedded-helpers-x9Tf7Zu1.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-DIBOMxEC.js";
import { t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, v as isBillingErrorMessage, x as isRateLimitErrorMessage, y as isOverloadedErrorMessage } from "./sanitize-user-facing-text-DVLttSO5.js";
import { v as resolvePathFromInput, x as parseReplyDirectives } from "./deliver-BfVgOanr.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-L3WabTAF.js";
import { d as LiveSessionModelSwitchError, l as isFallbackSummaryError, u as runWithModelFallback } from "./openclaw-tools-gljDkcq_.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-mHIFb5V8.js";
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-Bgfqr3vS.js";
import { u as saveMediaSource } from "./store-BqmRfmaG.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-CFyAzeE7.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-M0fJAPUh.js";
import { i as scheduleFollowupDrain, t as enqueueFollowupRun } from "./queue-DZ_zeJck.js";
import { s as refreshQueuedFollowupSession } from "./settings-runtime-CVvWjIXr.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-CtwpUP5M.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-XuiAjTgG.js";
import "./pi-embedded-J9RxT1Uw.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-DKG0yDpy.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-B-CZG8t9.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BhoZvfDj.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-CSbb2ghC.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CC-3xgaZ.js";
import { n as buildFallbackNotice, r as resolveFallbackTransition, t as buildFallbackClearedNotice } from "./fallback-state-CS7Bv_8T.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CNmxVA3i.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-CotWLsTV.js";
...
function isAllowedAbsoluteReplyMediaPath(params) {
	...
	return [params.workspaceDir, params.sandboxRoot].filter((root) => Boolean(root)).map((root) => path.join(path.resolve(root), AGENT_STATE_MEDIA_DIRNAME)).some((root) => isPathInside(root, params.candidate));
}
...
function createReplyMediaPathNormalizer(params) {
	...
	const persistVolatileAgentMedia = async (media) => {
		if (!path.isAbsolute(media)) return media;
		const sandboxRoot = await resolveSandboxRoot();
		if (![params.workspaceDir, sandboxRoot].filter((root) => Boolean(root)).map((root) => path.join(path.resolve(root), AGENT_STATE_MEDIA_DIRNAME)).some((root) => isPathInside(root, media))) return media;
		const cached = persistedMediaBySource.get(media);
		if (cached) return await cached;
		const persistPromise = saveMediaSource(media, void 0, "outbound").then((saved) => saved.path).catch((err) => {
	...
	const normalizeMediaSource = async (raw) => {
		...
		if (sandboxRoot) try {
			...
			if (!isLikelyLocalMediaSource(media) || FILE_URL_RE.test(media)) throw err;
			if (workspaceOnly) throw err;
			if (!path.isAbsolute(media)) return resolvePathFromInput(media, params.workspaceDir);
			if (isAllowedAbsoluteReplyMediaPath({
				candidate: media,
				workspaceDir: params.workspaceDir,
				sandboxRoot
			})) return media;
			throw new Error("Absolute host-local MEDIA paths are blocked in normal replies. Use a safe relative path or the message tool.", { cause: err });
		}
		if (!isLikelyLocalMediaSource(media)) return media;
		if (FILE_URL_RE.test(media)) throw new Error("Absolute host-local MEDIA file URLs are blocked in normal replies. Use a safe relative path or the message tool.");
		if (!path.isAbsolute(media)) return resolvePathFromInput(media, params.workspaceDir);
		if (isAllowedAbsoluteReplyMediaPath({
			candidate: media,
			workspaceDir: params.workspaceDir,
		...
		throw new Error("Absolute host-local MEDIA paths are blocked in normal replies. Use a safe relative path or the message tool.");
	};
	return async (payload) => {
...
async function compactEmbeddedPiSessionDefault(...args) {
	const { compactEmbeddedPiSession } = await import("./pi-embedded-DomNTcpR.js");
	return await compactEmbeddedPiSession(...args);
}
async function runEmbeddedPiAgentDefault(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded-DomNTcpR.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-BuALUPP4.js");
...
function buildInlinePluginStatusPayload(entry) {
	const statusLines = entry?.verboseLevel && entry.verboseLevel !== "off" ? resolveSessionPluginStatusLines(entry) : [];
...
async function runReplyAgent(params) {
	...
	try {
		...
		if (verboseEnabled) {
			...
			if (pluginStatusPayload) trailingPluginStatusPayload = pluginStatusPayload;
		}
