...
import { f as isPathInside$1, i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-4GSqtybS.js";
import { f as resolveConfigDir, l as isRecord, m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { a as resolvePackageExtensionEntries, i as loadPluginManifest, r as getPackageManifestMetadata, t as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-DVVfeFh-.js";
...
function listBundledChatChannelEntries() {
	return listChannelCatalogEntries({ origin: "bundled" }).flatMap(({ channel }) => {
		const id = normalizeOptionalLowercaseString(channel.id);
		if (!id) return [];
		return [{
			id,
			aliases: (channel.aliases ?? []).map((alias) => normalizeOptionalLowercaseString(alias)).filter((alias) => Boolean(alias)),
...
//#endregion
export { mergeBundlePathLists as _, clearPluginDiscoveryCache as a, resolvePluginSourceRoots as c, safeStatSync as d, CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH as f, loadBundleManifest as g, detectBundleManifestFormat as h, listChannelCatalogEntries as i, isPathInside as l, CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH as m, CHAT_CHANNEL_ORDER as n, discoverOpenClawPlugins as o, CODEX_BUNDLE_MANIFEST_RELATIVE_PATH as p, normalizeChatChannelId as r, resolvePluginCacheInputs as s, CHANNEL_IDS as t, safeRealpathSync as u, normalizeBundlePathList as v };
