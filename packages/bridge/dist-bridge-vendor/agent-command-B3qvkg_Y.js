...
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CprbVBQX.js";
import { n as matchesSkillFilter } from "./agent-filter-CtOfYR2u.js";
import { d as ensureAgentWorkspace } from "./workspace-LfA0pl0B.js";
import { a as resolveAgentDir, g as resolveEffectiveModelFallbacks, m as resolveAgentWorkspaceDir, p as resolveAgentSkillsFilter, r as listAgentIds, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { a as loadConfig, u as readConfigFileSnapshotForWrite } from "./io-CIh0_WgN.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BuTtS5Gf.js";
import { l as setRuntimeConfigSnapshot } from "./runtime-snapshot-DWfOZ0HB.js";
import "./config-_X90biGc.js";
import { S as shouldRefreshSnapshotForVersion, r as getRemoteSkillEligibility, t as canExecRequestNode, y as getSkillsSnapshotVersion } from "./exec-defaults-BjFX32hR.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-_RJJ480N.js";
import { o as normalizeAccountId } from "./delivery-context.shared-DQgMr1Hj.js";
import { a as isGatewayMessageChannel, d as normalizeMessageChannel, o as isInternalMessageChannel, p as resolveMessageChannel, r as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BsZYykgY.js";
...
import { D as parseModelRef, E as normalizeModelRef, S as isCliProvider, T as modelKey, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, t as buildAllowedModelSet, x as resolveThinkingDefault } from "./model-selection-DYo_mceY.js";
import { r as loadModelCatalog } from "./model-catalog-9wtELOal.js";
import { n as resolveSession, s as prepareSessionManagerForRun, t as runEmbeddedPiAgent } from "./pi-embedded-runner-CXwB_I4U.js";
...
import { r as resolveSessionTranscriptFile } from "./transcript-CxvrT_cw.js";
...
import { h as hasInternalRuntimeContext } from "./sanitize-user-facing-text-DVLttSO5.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-zRJA9LrI.js";
import { t as FailoverError } from "./failover-error-Dvvg9Pjq.js";
import { c as projectOutboundPayloadPlanForOutbound, i as normalizeOutboundPayloadsForJson, n as createOutboundPayloadPlan, o as projectOutboundPayloadPlanForJson, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-BfVgOanr.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-L3WabTAF.js";
import { d as LiveSessionModelSwitchError, u as runWithModelFallback } from "./openclaw-tools-gljDkcq_.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-B96PuGKj.js";
...
import { i as resolveSessionDeliveryTarget, r as resolveOutboundTarget } from "./targets-CjOwV09P.js";
import { E as AGENT_LANE_SUBAGENT, T as AGENT_LANE_NESTED, k as formatAgentInternalEventsForPrompt } from "./subagent-registry-C98AJ7CF.js";
import { t as normalizeReplyPayload } from "./normalize-reply-DDeXBK6_.js";
...
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-CdtiT-7T.js";
import "./pi-embedded-J9RxT1Uw.js";
import { i as toAcpRuntimeError } from "./errors-DuZeqcVS.js";
import { n as getAcpSessionManager } from "./manager-B3iT25IH.js";
import { n as resolveSendPolicy } from "./send-policy-Cw3tU_7b.js";
import { t as createReplyPrefixContext } from "./reply-prefix-xCFOErRQ.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-DDvYHrpY.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-CK_HUi46.js";
import { t as resolveAcpSessionCwd } from "./session-identifiers-DR3Kb_6F.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-CcgcCOKX.js";
import { t as createDefaultDeps } from "./deps-Dha_Kuiu.js";
import { n as applyVerboseOverride } from "./level-overrides-C4TN54oS.js";
import { a as setCliSessionBinding, n as clearCliSession, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CC-3xgaZ.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-DFFs6aBl.js";
...
async function getUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-ByGtGsyd.js");
	return await usageFormatModulePromise;
}
async function getContextModule() {
	contextModulePromise ??= import("./context-CSUMeiQD.js");
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const { resolvedConfig: cfg } = await resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
		targetIds: getAgentRuntimeCommandSecretTargetIds({ includeChannelTargets: params?.runtimeTargetsChannelSecrets === true }),
		runtime
	});
...
//#endregion
export { resolveAgentOutboundTarget as a, resolveAgentDeliveryPlan as i, agentCommand as n, agentCommandFromIngress as r, __testing as t };
