import { _ as resolveStateDir, l as resolveGatewayLockDir, o as resolveConfigPath } from "./paths-D9v5qmRt.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-CnQBeYRu.js";
import { r as isPidAlive } from "./process-scoped-map-BIyb6oMT.js";
import { d as parseProcCmdline, f as parseWindowsCmdline, u as isGatewayArgv } from "./restart-stale-pids-D3ihATqK.js";
...
async function acquireGatewayLock(opts = {}) {
	...
	const sleep = opts.sleep ?? (async (ms) => await new Promise((resolve) => setTimeout(resolve, ms)));
