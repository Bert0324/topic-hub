import { d as readStringValue, f as resolvePrimaryStringValue, i as normalizeLowercaseStringOrEmpty, r as lowercasePreservingWhitespace, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
...
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-CtOfYR2u.js";
...
function resolveAgentWorkspaceDir(cfg, agentId) {
	...
	if (fallback) return stripNullBytes(path.join(resolveUserPath(fallback), id));
...
//#endregion
export { resolveFallbackAgentId as _, resolveAgentDir as a, resolveSessionAgentIds as b, resolveAgentExplicitModelPrimary as c, resolveAgentModelFallbacksOverride as d, resolveAgentModelPrimary as f, resolveEffectiveModelFallbacks as g, resolveDefaultAgentId as h, resolveAgentConfig as i, resolveAgentIdByWorkspacePath as l, resolveAgentWorkspaceDir as m, listAgentEntries as n, resolveAgentEffectiveModelPrimary as o, resolveAgentSkillsFilter as p, listAgentIds as r, resolveAgentExecutionContract as s, hasConfiguredModelFallbacks as t, resolveAgentIdsByWorkspacePath as u, resolveRunModelFallbacksOverride as v, resolveSessionAgentId as y };
