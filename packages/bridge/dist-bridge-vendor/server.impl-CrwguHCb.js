import { t as SsrFBlockedError } from "./ssrf-BYiMTIR_.js";
import { t as truncateCloseReason } from "./close-reason-OCIPhhus.js";
import { a as normalizeNullableString, d as readStringValue, i as normalizeLowercaseStringOrEmpty, l as normalizeOptionalThreadValue, o as normalizeOptionalLowercaseString, r as lowercasePreservingWhitespace, s as normalizeOptionalString, u as normalizeStringifiedOptionalString } from "./string-coerce-D8LAEut5.js";
import { d as isNotFoundPathError, o as sameFileIdentity, r as openBoundaryFile } from "./boundary-file-read-4GSqtybS.js";
import { b as truncateUtf16Safe, m as resolveUserPath, s as ensureDir, v as sleep, x as isPlainObject } from "./utils-BpVTx0yp.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-C3oOCF_E.js";
import { i as formatErrorMessage, n as detectErrorKind } from "./errors-BTh8VBsl.js";
import { n as defaultRuntime } from "./runtime-DDp5sFCA.js";
import { t as sanitizeForLog } from "./ansi-Dm9DlII5.js";
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-DO8SAv56.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BkswxGUu.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-sTLdO-KP.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-D7g_ucIh.js";
import "./logging-NC9EwRsH.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-gF8HX_ml.js";
import { s as registerUnhandledRejectionHandler } from "./unhandled-rejections-aUxig3ce.js";
import { n as resolveAgentModelPrimaryValue } from "./model-input-CZL2P3ko.js";
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-D9v5qmRt.js";
import { _ as isAcpSessionKey, b as isSubagentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isCronRunSessionKey, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-BMe6W-KZ.js";
import { n as matchesSkillFilter } from "./agent-filter-CtOfYR2u.js";
import { a as logWarn, n as logError, t as logDebug } from "./logger-tSqm_V4O.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-BP7rAGD2.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, o as DEFAULT_MEMORY_ALT_FILENAME, p as isWorkspaceSetupCompleted, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-LfA0pl0B.js";
import { a as resolveAgentDir, g as resolveEffectiveModelFallbacks, h as resolveDefaultAgentId, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, n as listAgentEntries, p as resolveAgentSkillsFilter, r as listAgentIds, y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { d as PROFILE_OPTIONS, m as resolveCoreToolProfiles, p as listCoreToolSections } from "./tool-policy-DekfzodU.js";
import { E as applyConfigOverrides, G as resolveActiveTalkProviderConfig, J as resolveSubagentMaxConcurrent, U as buildTalkConfigResponse, W as normalizeTalkSection, a as loadConfig, h as writeConfigFile, i as getRuntimeConfig, l as readConfigFileSnapshot, m as resolveConfigSnapshotHash, o as parseConfigJson5, p as registerConfigWriteListener, q as resolveAgentMaxConcurrent, r as createConfigIO, u as readConfigFileSnapshotForWrite, x as validateConfigObjectWithPlugins } from "./io-CIh0_WgN.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-zl3pijE0.js";
import { n as VERSION, s as resolveRuntimeServiceVersion } from "./version-BajQ5RLp.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DCRfSnSx.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BuTtS5Gf.js";
import { i as applyMergePatch } from "./schema-validator-s2bic7WL.js";
import { a as normalizePluginsConfig } from "./config-state-9vPQf81t.js";
import { r as parseByteSize } from "./zod-schema-ddm1VQge.js";
import { t as parseDurationMs } from "./parse-duration-DOBbb8_k.js";
import "./config-_X90biGc.js";
import { _ as verifyNodeToken, a as recordRemoteNodeInfo, b as registerSkillsChangeListener, c as removeRemoteNodeInfo, d as getPairedNode, f as listNodePairing, g as updatePairedNodeMetadata, h as requestNodePairing, i as primeRemoteSkillsCache, l as setSkillsRemoteRegistry, m as renamePairedNode, o as refreshRemoteBinsForConnectedNodes, p as rejectNodePairing, r as getRemoteSkillEligibility, s as refreshRemoteNodeBins, t as canExecRequestNode, u as approveNodePairing, y as getSkillsSnapshotVersion } from "./exec-defaults-BjFX32hR.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-CSYEt1lm.js";
import { r as buildWorkspaceSkillSnapshot, s as loadWorkspaceSkillEntries } from "./skills-_RJJ480N.js";
import { n as hasBinary } from "./config-eval-C8j8yRJ8.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DCnQA28K.js";
import { c as roleScopesAllow, o as resolveMissingRequestedScope } from "./pairing-token-CbaL-c7W.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-CyG5Q-51.js";
import { t as safeEqualSecret } from "./secret-equal-CDezLtLr.js";
import { T as resolveExecApprovalRequestAllowedDecisions, _ as normalizeExecTarget, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions, y as readExecApprovalsSnapshot } from "./exec-approvals-BsyvYleM.js";
import { i as setHeartbeatsEnabled, n as requestHeartbeatNow } from "./heartbeat-wake-DlLYbFOv.js";
import { n as resolveGlobalSingleton } from "./global-singleton-Bu7EzZLX.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DQgMr1Hj.js";
import { a as isGatewayMessageChannel, c as isOperatorUiClient, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS, i as isGatewayCliClient, l as isWebchatClient, m as GATEWAY_CLIENT_CAPS, n as isBrowserOperatorUiClient, r as isDeliverableMessageChannel, v as hasGatewayClientCap } from "./message-channel-BsZYykgY.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-CKBbXDel.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-C60yWwZy.js";
import { t as formatCliCommand } from "./command-format-DDWL27WN.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-Cg1RPT_G.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-CCdFXL6G.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-Cpd6ZLxF.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-DJUswuFo.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-Duf03--7.js";
import { r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-DoZ1tyHd.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-MDj5RYW_.js";
import { _ as disposeRegisteredAgentHarnesses, r as loadOpenClawPlugins } from "./loader-B-B7CN7x.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-BY8xbNeY.js";
import { s as getPluginCommandSpecs } from "./command-registration-iyF8S6qf.js";
import { o as runGlobalGatewayStopSafely, t as getGlobalHookRunner } from "./hook-runner-global-CWxC3y8-.js";
import { f as registerInternalHook, h as unregisterInternalHook, i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent, p as setInternalHooksEnabled } from "./internal-hooks-0tvOr1P0.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-B-vyuIuj.js";
import { b as createEmptyPluginRegistry, f as releasePinnedPluginChannelRegistry, l as pinActivePluginChannelRegistry, p as releasePinnedPluginHttpRouteRegistry, r as getActivePluginRegistry, u as pinActivePluginHttpRouteRegistry, v as resolveActivePluginHttpRouteRegistry, y as setActivePluginRegistry } from "./runtime-DcBif8u5.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BGqMEM1a.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-BVsVJrWw.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DGmN5e8M.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-D2Ih7kkl.js";
import { a as normalizeElevatedLevel, c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeFastMode, s as normalizeReasoningLevel, u as normalizeUsageDisplay } from "./thinking.shared-nRv_dCJ1.js";
import { D as parseModelRef, E as normalizeModelRef, S as isCliProvider, a as getModelRefStatus, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, l as resolveAllowedModelRef, p as resolveHooksGmailModel, s as normalizeModelSelection, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-DYo_mceY.js";
import { t as resolveModel } from "./model-DLtFzYCE.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-D5QcGrZ_.js";
import { d as resolvePluginTools, u as getPluginToolMeta } from "./channel-tools-BYS-KHaL.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Br4uf9EO.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-TU93G5gE.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-BFqEcob-.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-tV8Em28r.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-DUwOuUHx.js";
import { a as resolveEffectiveSharedGatewayAuth, i as isLocalDirectRequest, n as authorizeHttpGatewayConnect, o as resolveGatewayAuth, r as authorizeWsControlUiGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-BpMEnTJc.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { r as pickBestEffortPrimaryLanIPv4 } from "./control-ui-links-D6yOulU2.js";
import { i as resolveAssistantAvatarUrl, r as normalizeControlUiBasePath } from "./control-ui-shared-B_UogItD.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-S_hwCNRl.js";
import { a as getPreauthHandshakeTimeoutMsFromEnv, i as resolveDeviceAuthConnectErrorDetailCode, n as ConnectErrorDetailCodes, o as buildDeviceAuthPayload, r as resolveAuthConnectErrorDetailCode, s as buildDeviceAuthPayloadV3 } from "./client-zpBLP0Kw.js";
import { i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity, o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-B57gmNDw.js";
import { t as rawDataToString } from "./ws-t5C428To.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-DpmcHALj.js";
import { $ as validateNodeInvokeParams, $t as validateWizardNextParams, A as validateCronRunParams, At as validateSessionsMessagesUnsubscribeParams, Bt as validateSkillsSearchParams, C as validateConfigSchemaLookupResult, Ct as validateSessionsCompactionGetParams, D as validateCronAddParams, Dt as validateSessionsDeleteParams, E as validateConnectParams, Et as validateSessionsCreateParams, F as validateDevicePairListParams, Ft as validateSessionsSendParams, G as validateExecApprovalsNodeGetParams, Gt as validateTalkSpeakParams, H as validateExecApprovalRequestParams, Ht as validateSkillsUpdateParams, I as validateDevicePairRejectParams, It as validateSessionsUsageParams, J as validateLogsTailParams, Jt as validateUpdateRunParams, K as validateExecApprovalsNodeSetParams, Kt as validateToolsCatalogParams, L as validateDevicePairRemoveParams, Lt as validateSkillsBinsParams, M as validateCronStatusParams, Mt as validateSessionsPreviewParams, N as validateCronUpdateParams, Nt as validateSessionsResetParams, O as validateCronListParams, Ot as validateSessionsListParams, P as validateDevicePairApproveParams, Pt as validateSessionsResolveParams, Q as validateNodeEventParams, Qt as validateWizardCancelParams, R as validateDeviceTokenRevokeParams, Rt as validateSkillsDetailParams, S as validateConfigSchemaLookupParams, St as validateSessionsCompactionBranchParams, T as validateConfigSetParams, Tt as validateSessionsCompactionRestoreParams, U as validateExecApprovalResolveParams, Ut as validateTalkConfigParams, V as validateExecApprovalGetParams, Vt as validateSkillsStatusParams, W as validateExecApprovalsGetParams, Wt as validateTalkModeParams, X as validateModelsListParams, Xt as validateWebLoginStartParams, Y as validateMessageActionParams, Yt as validateWakeParams, Z as validateNodeDescribeParams, Zt as validateWebLoginWaitParams, _t as validateSecretsResolveParams, a as validateAgentsCreateParams, an as parseSessionLabel, at as validateNodePairRequestParams, b as validateConfigGetParams, bt as validateSessionsAbortParams, c as validateAgentsFilesListParams, ct as validateNodePendingDrainParams, d as validateAgentsUpdateParams, dt as validatePluginApprovalRequestParams, en as validateWizardStartParams, et as validateNodeInvokeResultParams, f as validateChannelsLogoutParams, ft as validatePluginApprovalResolveParams, ht as validateRequestFrame, i as validateAgentWaitParams, in as COMMAND_DESCRIPTION_MAX_LENGTH, it as validateNodePairRejectParams, j as validateCronRunsParams, jt as validateSessionsPatchParams, k as validateCronRemoveParams, kt as validateSessionsMessagesSubscribeParams, l as validateAgentsFilesSetParams, lt as validateNodePendingEnqueueParams, mt as validatePushTestParams, n as validateAgentIdentityParams, nn as ErrorCodes, nt as validateNodePairApproveParams, o as validateAgentsDeleteParams, ot as validateNodePairVerifyParams, p as validateChannelsStatusParams, pt as validatePollParams, q as validateExecApprovalsSetParams, qt as validateToolsEffectiveParams, r as validateAgentParams, rn as errorShape, rt as validateNodePairListParams, s as validateAgentsFilesGetParams, st as validateNodePendingAckParams, t as formatValidationErrors, tn as validateWizardStatusParams, tt as validateNodeListParams, u as validateAgentsListParams, ut as validateNodeRenameParams, v as validateCommandsListParams, vt as validateSecretsResolveResult, w as validateConfigSchemaParams, wt as validateSessionsCompactionListParams, x as validateConfigPatchParams, xt as validateSessionsCompactParams, y as validateConfigApplyParams, yt as validateSendParams, z as validateDeviceTokenRotateParams, zt as validateSkillsInstallParams } from "./protocol-BxYXhZGl.js";
import { a as normalizeInputProvenance } from "./input-provenance-CRnmC8r0.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-BiSpdt5C.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, i as isNodeRoleMethod, l as READ_SCOPE, n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES, u as TALK_SECRETS_SCOPE } from "./method-scopes-CzgTst__.js";
import { n as isRestartEnabled } from "./commands.flags-DHhnmVjI.js";
import { n as formatConfigIssueLines } from "./issue-format-B_zhM8Uo.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CutJw60p.js";
import { r as loadModelCatalog } from "./model-catalog-9wtELOal.js";
import { n as resolveAgentIdentity } from "./identity-B3n7EZ4K.js";
import { a as compactEmbeddedPiSession, i as resolvePreferredSessionKeyForSessionIdMatches, o as selectAgentHarness, t as runEmbeddedPiAgent } from "./pi-embedded-runner-CXwB_I4U.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-CZFUytbr.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-axRgTD70.js";
import { l as setSessionRuntimeModel, n as mergeSessionEntry } from "./types-6DEWydwn.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-DonV4dhV.js";
import { t as parseSessionThreadInfo } from "./thread-info-DiDjFCRt.js";
import { i as resolveAgentSessionDirs } from "./targets-B2a-_WdT.js";
import { i as lookupContextTokens } from "./context-BLKsjObp.js";
import { n as getLatestSubagentRunByChildSessionKey, t as countActiveDescendantRuns } from "./subagent-registry-read-DTNORm01.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-Cd2GKMjD.js";
import { a as loadGatewaySessionRow, d as resolveGatewaySessionStoreTarget, i as loadCombinedSessionStoreForGateway, l as resolveFreshestSessionEntryFromStoreKeys, m as canonicalizeSpawnedByForAgent, n as listAgentsForGateway, o as loadSessionEntry, p as resolveSessionModelRef, r as listSessionsFromStore, s as migrateAndPruneGatewaySessionStoreKey, u as resolveGatewayModelSupportsImages } from "./session-utils-nUaAb7Y3.js";
import { c as hasNonzeroUsage, s as deriveSessionTotalTokens } from "./chat-envelope-BvqqZK_b.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BqNJ-U8P.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts, t as archiveFileOnDisk } from "./session-transcript-files.fs-CcRatL9v.js";
import { lt as getSessionCompactionCheckpoint, ut as listSessionCompactionCheckpoints } from "./model-context-tokens-BtPuWlQz.js";
import { f as CommandLane, i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-mO9kfkwk.js";
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-wcms1O8a.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BwgrIC7s.js";
import { s as stripHeartbeatToken } from "./heartbeat-DhJX9hg6.js";
import { t as getMachineDisplayName } from "./machine-name-DT3NeTWS.js";
import { t as detectMime } from "./mime-BY3E3Z_p.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-Dz_UY2jH.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BcggOJnr.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-zRJA9LrI.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-Dvvg9Pjq.js";
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-BfVgOanr.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-L3WabTAF.js";
import { _ as assertSafeCronSessionTargetId, d as LiveSessionModelSwitchError, g as normalizeCronJobPatch, h as normalizeCronJobInput, m as normalizeCronJobCreate, p as normalizeHttpWebhookUrl, u as runWithModelFallback, v as isInvalidCronSessionTargetIdError } from "./openclaw-tools-gljDkcq_.js";
import { c as normalizeTargetForProvider } from "./reply-payloads-dedupe-mHIFb5V8.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CaFzvY2B.js";
import { d as readLocalFileSafely, g as writeFileWithinRoot, t as SafeOpenError } from "./fs-safe-Co_6GYrb.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CIz4rmTW.js";
import { i as normalizeRequiredName, n as normalizeOptionalAgentId, r as normalizePayloadToSystemText } from "./normalize-D27-oEZX.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-B1zSykOp.js";
import { a as summarizeRestartSentinel, n as formatDoctorNonInteractiveHint, r as formatRestartSentinelMessage, s as writeRestartSentinel, t as consumeRestartSentinel } from "./restart-sentinel-BdmzhfrL.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-7XyXWA28.js";
import { r as cleanOldMedia } from "./store-BqmRfmaG.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-Wpl2WQZ0.js";
import { i as isKnownSecretTargetId } from "./target-registry-Nt93-eSW.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-mWCsIYwb.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-_un1VDqw.js";
import { i as resolveOutboundSessionRoute, o as maybeResolveIdLikeTarget, r as ensureOutboundSessionEntry, s as resetDirectoryCache, u as dispatchChannelMessageAction } from "./message-action-runner-DV3g6Yqp.js";
import { n as normalizePollInput } from "./polls-Bhfg-fwI.js";
import { t as buildChannelAccountBindings } from "./bindings-BbxbSOFG.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-CHQQyshp.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-3h0MF4q1.js";
import { l as failDelivery, o as ackDelivery, s as enqueueDelivery } from "./delivery-queue-BdhkQeAo.js";
import { i as resolveReplyToMode } from "./reply-threading-M0fJAPUh.js";
import { t as buildOutboundSessionContext } from "./session-context-CIpL1RBf.js";
import { h as mapAllowFromEntries } from "./channel-config-helpers-B6pulziY.js";
import { a as resolveOutboundTargetWithPlugin, i as resolveSessionDeliveryTarget, r as resolveOutboundTarget } from "./targets-CjOwV09P.js";
import { t as extractToolPayload } from "./tool-payload-eHC4_XtG.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId } from "./task-executor-DTBvc_JV.js";
import { D as resolveNestedAgentLane, _ as cleanupBrowserSessionsForLifecycleEnd, h as onSessionLifecycleEvent, n as countActiveDescendantRuns$1, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery, s as listDescendantRunsForRequester, y as movePathToTrash } from "./subagent-registry-C98AJ7CF.js";
import { r as clearSessionQueues } from "./queue-DZ_zeJck.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Ctggyt-w.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-XuiAjTgG.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DwPhObCu.js";
import { t as resolveAgentTimeoutMs } from "./timeout-oGay3Wrd.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-CdtiT-7T.js";
import { a as mapHookExternalContentSource, i as isExternalHookSession, n as detectSuspiciousPatterns, o as resolveHookExternalContentSource, t as buildSafeExternalPrompt } from "./external-content-CAN4Pl3f.js";
import { n as resolveCronStyleNow } from "./current-time-Cr9XOEbZ.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-CkYW5aSM.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BujNqSU5.js";
import "./pi-embedded-J9RxT1Uw.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-GunoyEwO.js";
import { n as getAcpSessionManager } from "./manager-B3iT25IH.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-U7j5e4dE.js";
import { r as listPluginCommands } from "./commands-ZkHKgS2c.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-DZu8Ff3J.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-D2S-NVjB.js";
import "./commands-registry-Cpq8HdKx.js";
import { o as getTotalPendingReplies } from "./dispatch-n5iezYg-.js";
import { n as resolveSendPolicy, t as normalizeSendPolicy } from "./send-policy-Cw3tU_7b.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-Dgh55aU-.js";
import { t as getChannelActivity } from "./channel-activity-CeCNSCz9.js";
import { o as readChannelAllowFromStoreSync } from "./pairing-store-Bb-XVaPT.js";
import { t as WizardCancelledError } from "./prompts-Bx_IVBsV.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-QMVbjGTF.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-pE74J4oY.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CZ4DlJYv.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BXJrbysg.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-B6x48Q3w.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-CpvFbgx2.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DMG8e9BR.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-DKG0yDpy.js";
...
import { n as resolveSessionAuthProfileOverride } from "./session-override-DDvYHrpY.js";
import { n as shouldApplyStartupContext, r as buildBareSessionResetPrompt, t as buildSessionStartupContextPrelude } from "./startup-context-Cy_lKI1i.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BQVZbeHD.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-x0D7F0JQ.js";
import { n as resolveAgentOutboundIdentity } from "./identity-5V6xIbPk.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-Dha_Kuiu.js";
import { i as parseVerboseOverride, n as applyVerboseOverride, r as parseTraceOverride, t as applyTraceOverride } from "./level-overrides-C4TN54oS.js";
import { i as getCliSessionId, s as closeMcpLoopbackServer, t as runCliAgent } from "./cli-runner-CC-3xgaZ.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-B8zBCncg.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, r as agentCommandFromIngress } from "./agent-command-B3qvkg_Y.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-DFFs6aBl.js";
import "./refresh-Cbdj-qLa.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed, r as normalizeDeclaredNodeCommands } from "./node-command-policy-pkTFCtpb.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-DUPGfHTv.js";
import { a as respondUnavailableOnNodeInvokeError, i as respondInvalidParams, n as mergeGatewayAuthConfig, o as respondUnavailableOnThrow, r as mergeGatewayTailscaleConfig, s as safeParseJson, t as ensureGatewayStartupAuth } from "./startup-auth-DZCWamPQ.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BgYWO4iL.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-kRtiNWgL.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-t2hb6uPM.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-DJ49h8ZM.js";
import "./agent-CjwodQSN.js";
import { n as shouldIncludeHook } from "./config-CVP7peC1.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-D21fc90b.js";
import { n as resolveSystemRunApprovalRequestContext, r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-XneTGtTY.js";
import "./cli-runner.runtime-CTQUfaM2.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-K5hoU8ma.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Cpl2C4kE.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DOlaoj9r.js";
import { t as loadProviderUsageSummary } from "./provider-usage-BMNYNC0D.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-BBJnfrmv.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-BoyXfQsW.js";
import { a as performGatewaySessionReset } from "./session-reset-service-bDdAF-Jv.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B_p_f_tm.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-BgAmIjvk.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-CQ4J_8Zo.js";
import { t as buildChannelUiCatalog } from "./catalog-B0Emt92t.js";
import { a as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-CiFPlfHq.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BLj4fJfp.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CdjaABu7.js";
import { n as getHealthSnapshot } from "./health-DvxDMZmg.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DWcn0R1A.js";
import { t as GatewayLockError } from "./gateway-lock-CLVRVXwo.js";
import { t as loadWorkspaceHookEntries } from "./workspace-Bi_32laQ.js";
import { t as readConfiguredLogTail } from "./log-tail-BGb33ajm.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CE74fTM8.js";
import { t as installSkill } from "./skills-install-Y2cYVZz4.js";
import { a as runChannelPluginStartupMaintenance, i as normalizeCronJobIdentityFields, n as computeNextRunAtMs, o as runGatewayUpdate, r as computePreviousRunAtMs, t as coerceFiniteScheduleNumber } from "./schedule-BjCWnhMx.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-7I1SDiqh.js";
import { t as runSetupWizard } from "./setup-6r6zml61.js";
import "./status-BXyDZjNS.js";
import { t as getStatusSummary } from "./status.summary-CU1Z9kM-.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-B4vo9pzy.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Co3ay7bB.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-9Ng0u66R.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DJg0Dzaj.js";
import { t as buildChannelAccountSnapshot } from "./status-DKZ8sbUT.js";
import { n as isLikelyInterimCronMessage, t as expectsSubagentFollowup } from "./subagent-followup-hints-DN48W_Xj.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-r1KmohTG.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CYNQI0YA.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DWlH4OIh.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-AbTvyBmi.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-D6vDCM0_.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-CBHdmQ9B.js");
...
function shouldSkipForwardingFallback(params) {
	...
	return resolveChannelApprovalAdapter(getChannelPlugin(channel))?.delivery?.shouldSuppressForwardingFallback?.({
		cfg: params.cfg,
...
function buildApprovalRenderPayload(params) {
	const channel = normalizeMessageChannel(params.target.channel) ?? params.target.channel;
	return (channel ? params.resolveRenderer(resolveChannelApprovalAdapter(getChannelPlugin(channel)))?.(params.renderParams) : null) ?? params.buildFallback();
}
...
function createApprovalHandlers(params) {
	...
	const handleRequested = async (request) => {
		...
		deliverToTargets({
			...
			log$6.error(`${params.strategy.kind} approvals: failed to deliver request ${requestId}: ${String(err)}`);
		});
		return true;
	};
...
function spawnGogServe(cfg) {
	...
	log$5.info(`starting gog ${buildGogWatchServeLogArgs(cfg).join(" ")}`);
...
function createGatewayCloseHandler(params) {
	return async (opts) => {
		try {
			...
			if (params.skipHttpServerClose) return;
...
async function loadTargetsRuntime() {
	targetsRuntimePromise ??= import("./targets.runtime-C2Y3Z_64.js");
...
async function loadChannelSelectionRuntime() {
	channelSelectionRuntimePromise ??= import("./channel-selection.runtime-BjvgW9pQ.js");
...
async function resolveDeliveryTarget(cfg, agentId, jobPayload) {
	...
	const storeAllowFrom = mapAllowFromEntries(readChannelAllowFromStoreSync(channel, process.env, resolvedAccountId));
	const allowFromOverride = [...new Set([...configuredAllowFrom, ...storeAllowFrom])];
	const effectiveAllowFrom = mode === "implicit" ? allowFromOverride : void 0;
...
function isFiniteTimestamp$1(value) {
	return typeof value === "number" && Number.isFinite(value);
}
function hasScheduledNextRunAtMs(value) {
	return isFiniteTimestamp$1(value) && value > 0;
}
...
function resolveEveryAnchorMs(params) {
	...
	if (isFiniteTimestamp$1(params.fallbackAnchorMs)) return Math.max(0, Math.floor(params.fallbackAnchorMs));
	return 0;
}
...
function computeJobNextRunAtMs(job, nowMs) {
	...
	if (job.schedule.kind === "every") {
		...
		const fallbackAnchorMs = isFiniteTimestamp$1(job.createdAtMs) ? job.createdAtMs : nowMs;
		...
		return isFiniteTimestamp$1(next) ? next : void 0;
	}
...
function computeJobPreviousRunAtMs(job, nowMs) {
	...
	return isFiniteTimestamp$1(previous) ? previous : void 0;
}
...
function normalizeJobTickState(params) {
	...
	if (job.schedule.kind === "every") {
		const normalizedAnchorMs = resolveEveryAnchorMs({
			schedule: job.schedule,
			fallbackAnchorMs: isFiniteTimestamp$1(job.createdAtMs) ? job.createdAtMs : nowMs
		});
...
function recomputeNextRunsForMaintenance(state, opts) {
	...
	return walkSchedulableJobs(state, ({ job, nowMs: now }) => {
		...
		if (!hasScheduledNextRunAtMs(job.state.nextRunAtMs)) {
			...
			if (isFiniteTimestamp$1(lastRun) && lastRun >= job.state.nextRunAtMs) {
				if (recomputeJobNextRunAtMs({
					state,
					job,
					nowMs: now
...
function resolveHeartbeatAckMaxChars$1(agentCfg) {
...
async function loadGatewayCallRuntime() {
	gatewayCallRuntimePromise ??= import("./call.runtime-M7CuEztS.js");
	return await gatewayCallRuntimePromise;
}
async function loadDeliveryOutboundRuntime() {
	deliveryOutboundRuntimePromise ??= import("./delivery-outbound.runtime-DHYArFe5.js");
	return await deliveryOutboundRuntimePromise;
}
async function loadSubagentFollowupRuntime() {
	subagentFollowupRuntimePromise ??= import("./subagent-followup.runtime-DmPJiKeH.js");
...
async function queueCronAwarenessSystemEvent(params) {
	const text = normalizeOptionalString(params.outputText) ?? normalizeOptionalString(params.synthesizedText);
	if (!text) return;
	try {
		...
		logWarn(`[cron:${params.jobId}] failed to queue isolated cron awareness for the main session: ${formatErrorMessage(err)}`);
	}
}
...
async function dispatchCronDelivery(params) {
	...
	const deliverViaDirect = async (delivery, options) => {
		...
		try {
			const payloadsForDelivery = (deliveryPayloads.length > 0 ? deliveryPayloads : synthesizedText ? [{ text: synthesizedText }] : []).filter((p) => !isSilentReplyText(p.text, SILENT_REPLY_TOKEN));
			...
			const onError = params.deliveryBestEffort ? (err, _payload) => {
				...
				logError(`[cron:${params.job.id}] delivery payload failed (bestEffort): ${formatErrorMessage(err)}`);
			} : void 0;
	...
	const finalizeTextDelivery = async (delivery) => {
		...
		if (isSilentReplyText(synthesizedText, "NO_REPLY")) return await finishSilentReplyDelivery();
		if (params.isAborted()) return params.withRunSession({
			status: "error",
			error: params.abortReason(),
			deliveryAttempted,
		...
		const fallbackResult = await runWithModelFallback({
			...
			run: async (providerOverride, modelOverride, runOptions) => {
				...
				if (isCliProvider(providerOverride, params.cfgWithAgentDefaults)) {
					const cliSessionId = params.cronSession.isNewSession ? void 0 : getCliSessionId(params.cronSession.sessionEntry, providerOverride);
...
async function executeCronRun(params) {
	...
	if (!params.isAborted()) {
		...
		if (!runResult.meta?.error && !runResult.didSendViaMessagingTool && !interimPayloadHasStructuredContent && !interimPayloads.some((payload) => payload?.isError === true) && !listDescendantRunsForRequester(params.agentSessionKey).some((entry) => {
		...
		}) && countActiveDescendantRuns$1(params.agentSessionKey) === 0 && isLikelyInterimCronMessage(interimText)) {
...
async function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-BrOU5yae.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-egyFkFQu.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-ByGtGsyd.js");
}
...
async function finalizeCronRun(params) {
	...
	const contextTokens = resolvePositiveContextTokens(prepared.agentCfg?.contextTokens) ?? lookupContextTokens(modelUsed, { allowAsyncLoad: false }) ?? resolvePositiveContextTokens(prepared.cronSession.sessionEntry.contextTokens) ?? 2e5;
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-BwQaXx1e.js");
}
...
async function readWorkspaceFileContent(workspaceDir, name) {
	...
	if (resolvedPath.kind !== "ready") return;
	try {
		return (await agentsHandlerDeps.readLocalFileSafely({ filePath: resolvedPath.ioPath })).buffer.toString("utf-8");
	} catch (err) {
	...
	"agents.create": async ({ params, respond }) => {
		...
		if (persistedIdentity) {
			if (!await writeWorkspaceFileOrRespond({
				...
				workspaceDir,
				name: "IDENTITY.md",
				content: await buildIdentityMarkdownForWrite({
					workspaceDir,
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-nvQaLOw2.js");
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-D_R8gViC.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-D_R8gViC.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DwtasZsj.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BkkADxF3.js");
		const { deliverOutboundPayloads } = await import("./deliver-fjN-rOFa.js");
...
function getBundledChannelsModule() {
	bundledChannelsModulePromise ??= import("./bundled-D8YmmbNS.js");
	return bundledChannelsModulePromise;
}
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-Cx8iNzPK.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-xpNzcHpT.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DZxQ6LrS.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-1MiqZkqh.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-Qvdgy9Oi.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-LGgJ1avr.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-Bo6i4Fzc.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-oHw9M7Xp.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BFAzNnqK.js");
...
/** Normalized mount prefix for embedding (always starts with `/`, no trailing slash except `/`). */
function normalizeGatewayEmbedPathPrefix(pathPrefix) {
	let p = pathPrefix.trim();
	if (!p.startsWith("/")) p = `/${p}`;
	const collapsed = p.replace(/\/+$/, "");
	return collapsed.length > 0 ? collapsed : "/";
}
function stripGatewayEmbedPathPrefixFromUrl(rawUrl, pathPrefix) {
	const prefix = normalizeGatewayEmbedPathPrefix(pathPrefix);
	let pathname = "/";
	let search = "";
	try {
	...
	return {
		pathname: pathname.length === prefix.length ? "/" : pathname.slice(prefix.length).startsWith("/") ? pathname.slice(prefix.length) : `/${pathname.slice(prefix.length)}`,
		search,
		matched: true
	};
}
async function resolvePluginGatewayAuthBypassPaths(configSnapshot) {
	...
	for (const plugin of listBundledChannelPlugins()) for (const path of plugin.gateway?.resolveGatewayAuthBypassPaths?.({ cfg: configSnapshot }) ?? []) if (typeof path === "string" && path.trim()) paths.add(path.trim());
	return paths;
}
...
/**
* Async gateway HTTP handler (same logic as {@link createGatewayHttpRequestListener}).
* Use this when the host must `await` the gateway before running other `request` listeners
* (e.g. Express on a shared `http.Server`).
*/
function createAsyncGatewayHttpRequestHandler(opts) {
...
function createGatewayHttpRequestListener(opts) {
	const handleRequest = createAsyncGatewayHttpRequestHandler(opts);
	return (req, res) => {
		handleRequest(req, res);
	};
}
function createGatewayHttpServer(opts) {
	const { tlsOptions, ...listenerOpts } = opts;
	const handleRequest = createGatewayHttpRequestListener(listenerOpts);
	return tlsOptions ? createServer$1(tlsOptions, (req, res) => {
		handleRequest(req, res);
...
function attachGatewayUpgradeHandler(opts) {
	const { httpServer, wss, canvasHost, clients, preauthConnectionBudget, resolvedAuth, rateLimiter, pathPrefix } = opts;
	const addUpgradeListener = pathPrefix ? httpServer.prependListener.bind(httpServer) : httpServer.on.bind(httpServer);
	const upgradeListener = (req, socket, head) => {
		(async () => {
			if (pathPrefix) {
				const stripped = stripGatewayEmbedPathPrefixFromUrl(req.url ?? "/", pathPrefix);
...
Too many unauthenticated sockets`);
	...
	addUpgradeListener("upgrade", upgradeListener);
	return () => {
...
async function createGatewayRuntimeState(params) {
	...
	try {
		...
		if (params.embed) {
			...
			const existingListeners = parent.listeners("request").slice();
			/**
			...
			*/
			const combinedRequestListener = (req, res) => {
				if ((req.headers.upgrade ?? "").toLowerCase() === "websocket") {
					for (const fn of existingListeners) fn(req, res);
					return;
				}
				const stripped = stripGatewayEmbedPathPrefixFromUrl(req.url ?? "/", pathPrefix);
				if (!stripped.matched) {
				...
				(async () => {
					...
					if (!res.writableEnded && !res.headersSent) for (const fn of existingListeners) fn(req, res);
				})();
			};
			...
			embedHttpDetach = () => {
				...
				for (const fn of existingListeners) parent.on("request", fn);
				detachUpgrade();
			};
...
async function startGatewayPostAttachRuntime(params) {
	logGatewayStartup({
		cfg: params.cfgAtStart,
		bindHost: params.bindHost,
	...
	const stopGatewayUpdateCheck = params.minimalTestGateway ? () => {} : scheduleGatewayUpdateCheck({
		cfg: params.cfgAtStart,
		log: params.log,
		isNixMode: params.isNixMode,
	...
	const tailscaleCleanup = params.minimalTestGateway ? null : await startGatewayTailscaleExposure({
		tailscaleMode: params.tailscaleMode,
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (authBootstrap.persistedGeneratedToken || controlUiSeed.persistedAllowedOriginsSeed) startupInternalWriteHash = (await readConfigFileSnapshot()).hash ?? null;
	...
	const { canvasHost, releasePluginRouteRegistry, httpServer, httpServers, httpBindHosts, wss, preauthConnectionBudget, clients, broadcast, broadcastToConnIds, agentRunSeq, dedupe, chatRunState, chatRunBuffers, chatDeltaSentAt, chatDeltaLastBroadcastLen, addChatRun, removeChatRun, chatAbortControllers, toolEventRecipients, embedHttpDetach } = await createGatewayRuntimeState({
		...
		getReadiness,
		...opts.embed ? { embed: {
			parentHttpServer: opts.embed.httpServer,
			pathPrefix: opts.embed.pathPrefix
		} } : {}
	});
	...
	const closeOnStartupFailure = async () => {
		...
		await createGatewayCloseHandler({
			...
			httpServer,
			httpServers,
			skipHttpServerClose: Boolean(opts.embed),
			embedHttpDetach: void 0
