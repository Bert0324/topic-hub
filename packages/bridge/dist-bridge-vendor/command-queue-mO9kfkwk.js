...
import { i as logLaneEnqueue, r as logLaneDequeue, t as diagnosticLogger } from "./diagnostic-runtime-t6LWRwoW.js";
...
function waitForActiveTasks(timeoutMs) {
	...
	if (timeoutMs <= 0) return Promise.resolve({ drained: false });
...
//#endregion
export { getActiveTaskCount as a, markGatewayDraining as c, waitForActiveTasks as d, CommandLane as f, enqueueCommandInLane as i, resetAllLanes as l, GatewayDrainingError as n, getQueueSize as o, clearCommandLane as r, getTotalQueueSize as s, CommandLaneClearedError as t, setCommandLaneConcurrency as u };
