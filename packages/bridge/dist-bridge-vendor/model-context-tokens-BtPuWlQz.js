import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, n as localeLowercasePreservingWhitespace, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-D8LAEut5.js";
import { i as openBoundaryFileSync, r as openBoundaryFile } from "./boundary-file-read-4GSqtybS.js";
import { l as isRecord, m as resolveUserPath, x as isPlainObject } from "./utils-BpVTx0yp.js";
import { i as redactToolDetail } from "./redact-uK0bEIef.js";
import { i as formatErrorMessage } from "./errors-BTh8VBsl.js";
import { t as createSubsystemLogger } from "./subsystem-BM4rdzkv.js";
import { i as normalizeChannelId } from "./registry-BkswxGUu.js";
import { n as retryAsync } from "./retry-DvlentmI.js";
import { n as isAbortError } from "./unhandled-rejections-aUxig3ce.js";
...
import { y as resolveSessionAgentId } from "./agent-scope-D2A6iYD-.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-B9YU5G_Z.js";
...
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BuTtS5Gf.js";
import { i as applyMergePatch } from "./schema-validator-s2bic7WL.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-9vPQf81t.js";
import { t as parseDurationMs } from "./parse-duration-DOBbb8_k.js";
import { s as loadWorkspaceSkillEntries } from "./skills-_RJJ480N.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-jnbPgR23.js";
import "./plugins-C60yWwZy.js";
import { t as acquireSessionWriteLock } from "./session-write-lock-CCdFXL6G.js";
import { t as resolveAccountEntry } from "./account-lookup-Duf03--7.js";
import { A as resolveProviderCacheTtlEligibility, I as resolveProviderRuntimePlugin, V as resolveProviderTransportTurnStateWithPlugin, W as resolveProviderWebSocketSessionPolicyWithPlugin, Z as validateProviderReplayTurnsWithPlugin, q as sanitizeProviderReplayHistoryWithPlugin } from "./provider-runtime-ljZXzW8q.js";
import { a as resolveRuntimePluginRegistry, u as getCompactionProvider } from "./loader-B-B7CN7x.js";
...
import { p as sanitizeForConsole } from "./order-Co3gVz_f.js";
import "./model-selection-DYo_mceY.js";
import { i as getModelProviderRequestTransport, l as resolveProviderRequestPolicyConfig, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-DCwotaaa.js";
import { a as normalizeOpenAIStrictToolParameters, l as mergeTransportMetadata, o as resolveOpenAIStrictToolFlagForInventory, p as createAnthropicVertexStreamFnForModel, r as createBoundaryAwareStreamFnForModel, s as resolveOpenAIStrictToolSetting } from "./provider-stream-rZLdlDYf.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-BmJyZc7M.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-DohMHKE2.js";
import { t as rawDataToString } from "./ws-t5C428To.js";
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-CRnmC8r0.js";
import { c as updateSessionStore } from "./store-CZFUytbr.js";
import "./sessions-axRgTD70.js";
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-CNiaIDn9.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DonV4dhV.js";
import { d as resolveGatewaySessionStoreTarget } from "./session-utils-nUaAb7Y3.js";
import { l as makeZeroUsageSnapshot, u as normalizeUsage } from "./chat-envelope-BvqqZK_b.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-DJIhavaZ.js";
import { i as resolveContextWindowInfo } from "./context-window-guard-My1TcKCS.js";
import { a as isSilentReplyText } from "./tokens-BwgrIC7s.js";
import { s as stripHeartbeatToken } from "./heartbeat-DhJX9hg6.js";
import { I as sanitizeGoogleTurnOrdering, c as extractToolCallsFromAssistant, d as downgradeOpenAIFunctionCallReasoningPairs, f as downgradeOpenAIReasoningBlocks, l as extractToolResultId, n as validateGeminiTurns, p as isGoogleModelApi, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist } from "./pi-embedded-helpers-x9Tf7Zu1.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BG8bgK9t.js";
import { a as isTimeoutError } from "./failover-error-Dvvg9Pjq.js";
import { t as log$4 } from "./logger-BPvqlpKv.js";
import { b as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-RbfEPGsk.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-BKOhghzC.js";
import { a as loadEmbeddedPiMcpConfig, o as describeStdioMcpServerLaunchConfig, s as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-tools-CXkvr7pD.js";
import { t as collectTextContentBlocks } from "./content-blocks-irFGQI8t.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-B9ICih3I.js";
import { c as jsonResult, u as payloadTextResult } from "./common-CqmjNIs4.js";
import { i as runBeforeToolCallHook, r as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-kkKlzrGI.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-CyOxx3eo.js";
import { c as sanitizeToolCallInputs, l as sanitizeToolUseResultPairing, o as makeMissingToolResult, r as isGooglePromptCacheEligible, s as repairToolUseResultPairing, u as stripToolResultDetails } from "./extra-params-YA7NJcFo.js";
import { i as resolveUserTimezone } from "./date-time-DUh5tyg7.js";
import { h as shouldPreserveThinkingBlocks } from "./provider-model-shared-BM2OhAPX.js";
import { n as isAnthropicFamilyCacheTtlEligible, r as isAnthropicModelRef } from "./anthropic-cache-control-payload-D_-HldFv.js";
import { t as withTimeout } from "./with-timeout-apbQl84u.js";
import { n as resolveCronStyleNow } from "./current-time-Cr9XOEbZ.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-CLWj9BmV.js";
import "./query-DEbn1DDg.js";
import { r as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-D83XxDVi.js";
import { t as estimateStringChars } from "./cjk-chars-DzY8giRK.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-CkYW5aSM.js";
...
function buildOpenAIWebSocketResponseCreatePayload(params) {
	...
	const reasoningEffort = streamOpts?.reasoningEffort ?? streamOpts?.reasoning ?? (params.model.reasoning ? "high" : void 0);
	if (reasoningEffort !== "none" && (reasoningEffort || streamOpts?.reasoningSummary)) {
		const reasoning = {};
		if (reasoningEffort !== void 0) reasoning.effort = reasoningEffort;
...
var OpenAIWebSocketManager = class extends EventEmitter {
	constructor(options = {}) {
		...
		this.socketFactory = options.socketFactory ?? ((url, socketOptions) => new WebSocket$1(url, socketOptions));
	...
	*/
	close() {
		...
		if (this.ws) {
			...
			try {
				if (this.ws.readyState === WebSocket$1.OPEN) this.ws.close(1e3, "Client closed");
				else if (this.ws.readyState === WebSocket$1.CONNECTING) this.ws.terminate();
			} catch {}
			this.ws = null;
		}
	}
...
function truncateToolResultText(text, maxChars, options = {}) {
	...
	if (hasImportantTail(text) && budget > minKeepChars * 2) {
		...
		if (headBudget > minKeepChars) {
			...
			return keptText + suffixFactory(Math.max(1, text.length - keptText.length));
		}
	}
	let cutPoint = budget;
...
function truncateToolResultMessage(msg, maxChars, options = {}) {
	...
	const newContent = content.map((block) => {
		...
		const blockBudget = Math.max(minKeepChars + defaultSuffix.length, Math.floor(maxChars * blockShare));
		return {
			...textBlock,
...
function calculateRecoveryAggregateToolResultChars(contextWindowTokens) {
	return Math.max(calculateMaxToolResultChars(contextWindowTokens), RECOVERY_MIN_TRUNCATED_TEXT_CHARS);
}
	...
	*/
	...
	const guardedAppend = (message) => {
		...
		if (nextRole === "toolResult") {
			...
			const persisted = applyBeforeWriteHook(persistToolResult(capToolResultSize(persistMessage(normalizePersistedToolResultName(nextMessage, toolName))), {
...
//#endregion
export { createPreparedEmbeddedPiSettingsManager as $, buildEmbeddedExtensionFactories as A, resolveCompactionTimeoutMs as B, prewarmSessionFile as C, buildEmbeddedMessageActionDiscoveryInput as D, validateReplayTurns as E, isRealConversationMessage as F, guardSessionManager as G, readLastCacheTtlTimestamp as H, readPostCompactionContext as I, truncateOversizedToolResultsInSession as J, estimateToolResultReductionPotential as K, consumeCompactionSafeguardCancelReason as L, SAFETY_MARGIN as M, estimateMessagesTokens as N, getDmHistoryLimitFromSessionKey as O, hasMeaningfulConversationContent as P, toClientToolDefinitions as Q, setCompactionSafeguardCancelReason as R, resolveEmbeddedRunSkillEntries as S, sanitizeSessionHistory as T, resolveTranscriptPolicy as U, isCacheTtlEligibleProvider as V, shouldAllowProviderOwnedThinkingReplay as W, installToolResultContextGuard as X, truncateOversizedToolResultsInSessionManager as Y, repairSessionFileIfNeeded as Z, createSystemPromptOverride as _, runAfterCompactionHooks as a, isHeartbeatOkResponse as at, resolveEmbeddedAgentBaseStreamFn as b, ensureRuntimePluginsLoaded as c, cleanupCompactionCheckpointSnapshot as ct, flushPendingToolResultsAfterIdle as d, persistSessionCompactionCheckpoint as dt, createBundleLspToolRuntime as et, mapThinkingLevel as f, resolveSessionCompactionCheckpointReason as ft, buildEmbeddedSystemPrompt as g, applySystemPromptOverrideToSession as h, estimateTokensAfterCompaction as i, filterHeartbeatPairs as it, dropThinkingBlocks as j, limitHistoryTurns as k, buildEmbeddedCompactionRuntimeContext as l, getSessionCompactionCheckpoint as lt, collectAllowedToolNames as m, asCompactionHookRunner as n, buildStreamErrorAssistantMessage as nt, runBeforeCompactionHooks as o, isHeartbeatUserMessage as ot, splitSdkTools as p, sessionLikelyHasOversizedToolResults as q, buildBeforeCompactionHookMetrics as r, resolveChannelCapabilities as rt, runPostCompactionSideEffects as s, captureCompactionCheckpointSnapshot as st, readPiModelContextTokens as t, releaseWsSession as tt, resolveEmbeddedCompactionTarget as u, listSessionCompactionCheckpoints as ut, describeEmbeddedAgentStreamStrategy as v, trackSessionManagerAccess as w, resolveEmbeddedAgentStreamFn as x, resolveEmbeddedAgentApiKey as y, compactWithSafetyTimeout as z };
