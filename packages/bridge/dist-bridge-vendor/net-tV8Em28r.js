...
import { d as isPrivateOrLoopbackIpAddress, i as isCanonicalDottedDecimalIPv4, o as isIpInCidr, p as normalizeIpAddress, u as isLoopbackIpAddress } from "./ip-CqT8RkYB.js";
import { a as readNetworkInterfaces, i as pickMatchingExternalInterfaceAddress, n as pickPrimaryTailnetIPv4 } from "./tailnet-BFqEcob-.js";
...
function isContainerEnvironment() {
	if (_containerCacheResult !== void 0) return _containerCacheResult;
...
async function resolveGatewayBindHost(bind, customHost) {
	...
	if (mode === "auto") {
		if (isContainerEnvironment()) return "0.0.0.0";
		if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
		return "0.0.0.0";
	}
	return "0.0.0.0";
...
*/
function defaultGatewayBindMode(tailscaleMode) {
	if (tailscaleMode && tailscaleMode !== "off") return "loopback";
...
//#endregion
export { resolveRequestClientIp as _, isLoopbackHost as a, isSecureWebSocketUrl as c, normalizeHostHeader as d, pickPrimaryLanIPv4 as f, resolveHostName as g, resolveGatewayListenHosts as h, isLoopbackAddress as i, isTrustedProxyAddress as l, resolveGatewayBindHost as m, isContainerEnvironment as n, isPrivateOrLoopbackAddress as o, resolveClientIp as p, isLocalishHost as r, isPrivateOrLoopbackHost as s, defaultGatewayBindMode as t, isValidIPv4 as u };
