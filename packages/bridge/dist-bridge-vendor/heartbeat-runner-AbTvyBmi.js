...
import { i as formatErrorMessage, o as hasErrnoCode } from "./errors-BTh8VBsl.js";
...
import { b as isSubagentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-CprbVBQX.js";
import { i as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-LfA0pl0B.js";
import { h as resolveDefaultAgentId, i as resolveAgentConfig, m as resolveAgentWorkspaceDir } from "./agent-scope-D2A6iYD-.js";
import { a as loadConfig } from "./io-CIh0_WgN.js";
import "./config-_X90biGc.js";
import { a as resolveHeartbeatReasonKind, n as requestHeartbeatNow, r as setHeartbeatWakeHandler, t as areHeartbeatsEnabled } from "./heartbeat-wake-DlLYbFOv.js";
import { s as peekSystemEventEntries, t as consumeSystemEventEntries, u as resolveSystemEventDeliveryContext } from "./system-events-CKBbXDel.js";
import "./plugins-C60yWwZy.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-Cg1RPT_G.js";
import { u as resolveStorePath } from "./paths-CDyGaBO4.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-B57gmNDw.js";
import { r as resolveEffectiveMessagesConfig } from "./identity-B3n7EZ4K.js";
import "./pi-embedded-runner-CXwB_I4U.js";
import { c as updateSessionStore, o as saveSessionStore, t as archiveRemovedSessionTranscripts } from "./store-CZFUytbr.js";
import { n as evaluateSessionFreshness, o as resolveSessionResetPolicy } from "./reset-CrFnICN4.js";
import { t as loadSessionStore } from "./store-load-DFwxULDf.js";
import { f as CommandLane, o as getQueueSize } from "./command-queue-mO9kfkwk.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-BwgrIC7s.js";
import { a as parseHeartbeatTasks, i as isTaskDue, o as resolveHeartbeatPrompt$1, r as isHeartbeatContentEffectivelyEmpty, s as stripHeartbeatToken } from "./heartbeat-DhJX9hg6.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-BPva_LgX.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-ciaCG5Jv.js";
import { t as deliverOutboundPayloads } from "./deliver-BfVgOanr.js";
import { t as buildOutboundSessionContext } from "./session-context-CIpL1RBf.js";
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-CjOwV09P.js";
import { a as resolveEmbeddedSessionLane } from "./queue-DZ_zeJck.js";
import { i as resolveUserTimezone } from "./date-time-DUh5tyg7.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-Cr9XOEbZ.js";
import { t as resolveHeartbeatReplyPayload } from "./heartbeat-reply-payload-BXVs2DbJ.js";
import { n as emitHeartbeatEvent, o as resolveIndicatorType, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BQVZbeHD.js";
...
function loadHeartbeatRunnerRuntime() {
	heartbeatRunnerRuntimePromise ??= import("./heartbeat-runner.runtime-HyHZHfjy.js");
...
After completing all due tasks, reply HEARTBEAT_OK.`;
			if (params.heartbeatFileContent) {
				const directives = params.heartbeatFileContent.replace(/^[\s\S]*?^tasks:[\s\S]*?(?=^[^\s]|^$)/m, "").trim();
...
async function runHeartbeatOnce(opts) {
	...
	if ((opts.deps?.getQueueSize ?? getQueueSize)(sessionLaneKey) > 0) {
		emitHeartbeatEvent({
			status: "skipped",
			reason: "requests-in-flight",
			durationMs: Date.now() - startedAt
	...
	if (prompt === null) {
		if (preflight.shouldInspectPendingEvents && preflight.pendingEventEntries.length > 0) consumeSystemEventEntries(sessionKey, preflight.pendingEventEntries);
		return {
			status: "skipped",
			reason: "no-tasks-due"
		};
...
//#endregion
export { resolveCronSession as a, isCronSystemEvent as i, runHeartbeatOnce as n, startHeartbeatRunner as r, resolveHeartbeatPrompt as t };
