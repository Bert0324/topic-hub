...
import { s as getChatChannelMeta } from "./registry-BRjSWImW.js";
import { f as resolveConfigDir, l as isRecord, m as resolveUserPath } from "./utils-BpVTx0yp.js";
import { r as normalizeChatChannelId } from "./ids-BhKtFNS_.js";
import { t as isBlockedObjectKey } from "./prototype-keys-B9rjoUHr.js";
import { t as resolvePluginSetupAutoEnableReasons } from "./setup-registry-D8Eid6bm.js";
import { n as loadPluginManifestRegistry, r as resolveManifestContractOwnerPluginId } from "./manifest-registry--_2x2rrY.js";
import { r as normalizeProviderId } from "./provider-id-DDriY74A.js";
import { r as withBundledPluginVitestCompat } from "./bundled-compat-WJYsICp_.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-9vPQf81t.js";
import { n as createPluginIdScopeSet, t as isChannelConfigured } from "./channel-configured-jSiWbzTw.js";
import { n as listPotentialConfiguredChannelIds, t as hasPotentialConfiguredChannels } from "./config-presence-n0cRxzU8.js";
import { t as ensurePluginAllowlisted } from "./plugins-allowlist-kU8qvNM6.js";
...
function shouldSkipPreferredPluginAutoEnable(params) {
	for (const other of params.configured) {
		...
		if (resolvePreferredOverIds(other, params.env, params.registry).includes(params.entry.pluginId)) return true;
	}
	return false;
}
//#endregion
...
function resolvePluginAutoEnableManifestRegistry(params) {
	return params.manifestRegistry ?? (configMayNeedPluginManifestRegistry(params.config) ? loadPluginManifestRegistry({
		config: params.config,
		env: params.env
