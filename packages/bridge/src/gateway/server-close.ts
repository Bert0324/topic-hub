...
export function createGatewayCloseHandler(params: {
  ...
  /** When true, do not close underlying HTTP servers (embedded gateway on a parent server). */
  skipHttpServerClose?: boolean;
  /** Remove embedded HTTP/WS listeners from the parent server before other teardown. */
